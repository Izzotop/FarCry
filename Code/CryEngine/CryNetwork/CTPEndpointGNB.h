...
public:
    ...
    virtual ~CCTPEndpointGNB();
    void Reset();
    void Init(_IEndpointUser* pParent, bool bSecondary) {
        m_pParent = pParent;
    ...
    unsigned int GetLostPackets() {
        return m_nLostPackets;
    }
    unsigned int GetUnreliableLostPackets() {
        return m_nUnreliableLostPackets;
    }
