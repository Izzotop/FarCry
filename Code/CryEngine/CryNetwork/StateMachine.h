...
#define BEGIN_STATUS_MAP()                                                                                                                                                         \
    void _ProcessSignal(unsigned int dwIncomingSignal, ULONG_PTR dwParam) {                                                                                                        \
        if (HandleANY(dwIncomingSignal, dwParam) == ANY_SIGNAL_NOT_HANDLED)                                                                                                        \
            switch (m_dwStatus) {

#define STATUS_ENTRY(_signal, _handler)                                                                                                                                            \
    case _signal:                                                                                                                                                                  \
        _handler(dwIncomingSignal, dwParam);                                                                                                                                       \
        break;

#define END_STATUS_MAP()                                                                                                                                                           \
    default:                                                                                                                                                                       \
...
#define ANY_SIGNAL_EXCEPT(status)                                                                                                                                                  \
    {                                                                                                                                                                              \
        if (m_dwStatus == status) {                                                                                                                                                \
