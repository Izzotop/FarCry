...
//////////////////////////////////////////////////////////////////////////
CBugsFlock::CBugsFlock(int id, CFlockManager* flockMgr) : CFlock(id, flockMgr) {}
...
void CBugsFlock::CreateBoids(SBoidsCreateContext& ctx) {
    ...
    for (i = 0; i < ctx.boidsCount; i++) {
        ...
        boid->m_pos = m_origin + Vec3(radius * frand(), radius * frand(), m_bc.MinHeight + (m_bc.MaxHeight - m_bc.MinHeight) * frand());
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
CBoidBug::CBoidBug(SBoidContext& bc) : CBoidObject(bc) {
    m_objectId = 0;
    m_onGround = 0;
}
...
void CBoidBug::UpdateFrogsBehavior(float dt, SBoidContext& bc) {
    if (m_onGround) {
        if (((rand() % 100) == 1) || (GetLengthSquared(Vec3(bc.playerPos.x - m_pos.x, bc.playerPos.y - m_pos.y, 0)) < BUGS_SCARE_DISTANCE * BUGS_SCARE_DISTANCE)) {
