...
class CUIListView : public CUIWidget, public _ScriptableEx<CUIListView> {
...
public:
    ...
    int AddColumn(const wstring& szLabel, float fWidth, int iHTextAlignment = UIALIGN_LEFT, const color4f& cHeaderColor = color4f(0.75f, 0.75f, 0.75f, 1.0f),
                  const color4f& cBodyColor = color4f(0.75f, 0.75f, 0.75f, 1.0f), const UISkinTexture& pHeaderTexture = UISkinTexture(), bool bNumeric = 0, bool bSelectable = 1,
                  bool bImageSort = 0);
