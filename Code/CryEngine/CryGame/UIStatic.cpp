...
CUIStatic::CUIStatic()
    : m_fVerticalOffset(0), m_fHorizontalOffset(0), m_bVerticalScrollBar(0), m_bHorizontalScrollBar(0), m_pHScroll(0), m_pVScroll(0), m_iHAlignment(UIALIGN_LEFT),
      m_iVAlignment(UIALIGN_MIDDLE), m_fTotalWidth(0.0f), m_fTotalHeight(0.0f), m_fLineHeight(0), m_fLineSpacing(0.0f), m_pModel(0), m_fAngle(0), m_fCameraDistance(4.0f),
      m_fCameraFov(35.0f * gf_PI / 180.0f), m_fModelRotation(0.1f), m_fLightDistance(50.0f), m_fModelRotationAcc(1.0f), m_fMouseMultiplier(1.0f), m_iMaxLines(100),
      m_fLeftSpacing(0.0f), m_fRightSpacing(0.0f) {}
