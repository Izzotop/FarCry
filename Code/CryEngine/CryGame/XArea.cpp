...
//////////////////////////////////////////////////////////////////////////
CXArea::CXArea() : m_VOrigin(0.0f), m_VSize(0.0f), m_PrevFade(-1.0f), m_Proximity(5.0f), m_AreaGroupID(-1), m_AreaID(-1), m_bIsActive(false) {
...
bool CXArea::IsPointWithin(const Vec3d& point3d) const {
    ...
    */
    ...
    if (m_AreaType == ATP_BOX) {
        ...
        if ((p3d.x < m_Min.x) || (p3d.y < m_Min.y) || (p3d.z < m_Min.z) || (p3d.x > m_Max.x) || (p3d.y > m_Max.y) || (p3d.z > m_Max.z))
            return false;
        return true;
    }
        ...
        for (unsigned int sIdx = 0; sIdx < m_vpSegments.size(); sIdx++) {
            ...
            if (!m_vpSegments[sIdx]->bbox.PointOutBBox2DVertical(*point))
                if (m_vpSegments[sIdx]->IntersectsXPosVertical(*point))
                    cntr++;
                else if (!m_vpSegments[sIdx]->bbox.PointOutBBox2DVertical(*point))
...
void CXArea::Draw(const ISystem* const pSystem, const int idx) {
    CFColor colorsArray[] = {
        CFColor(1.0f, 0.0f, 0.0f, 1.0f), CFColor(0.0f, 1.0f, 0.0f, 1.0f), CFColor(0.0f, 0.0f, 1.0f, 1.0f), CFColor(1.0f, 1.0f, 0.0f, 1.0f),
        CFColor(1.0f, 0.0f, 1.0f, 1.0f), CFColor(0.0f, 1.0f, 1.0f, 1.0f), CFColor(1.0f, 1.0f, 1.0f, 1.0f),
    };
...
CXAreaMgr::CXAreaMgr() : m_sCurStep(3) {
...
// width      -  fade width (m_Proximity), from border to withing
//////////////////////////////////////////////////////////////////////////
CXArea* CXAreaMgr::AddArea(const Vec3d& center, const float radius, const std::vector<string>& names, const int id,
                   const int groupId, const float width)
{
    CXArea* newArea;
...
// width  - fade width (m_Proximity), from border to withing
CXArea *CXAreaMgr::AddArea(const Vec3d *const vPoints, const int count, const std::vector<string> &names, const int id,
                           const int groupId, const float width)
{
    CXArea* newArea;
...
//////////////////////////////////////////////////////////////////////////
IXArea* CXGame::CreateArea(const Vec3d* vPoints, const int count, const std::vector<string>& names, const int type, const int groupId, const float width, const float height) {
...
//////////////////////////////////////////////////////////////////////////
IXArea* CXGame::CreateArea(const Vec3d& min, const Vec3d& max, const Matrix44& TM, const std::vector<string>& names, const int type, const int groupId, const float width) {
    return m_XAreaMgr.AddArea(min, max, TM, names, type, groupId, width);
}

//////////////////////////////////////////////////////////////////////////
IXArea* CXGame::CreateArea(const Vec3d& center, const float radius, const std::vector<string>& names, const int type, const int groupId, const float width) {
...
//////////////////////////////////////////////////////////////////////////
IXArea* CXAreaMgr::CreateArea(const Vec3d* vPoints, const int count, const std::vector<string>& names, const int type, const int groupId, const float width, const float height) {
...
//////////////////////////////////////////////////////////////////////////
IXArea* CXAreaMgr::CreateArea(const Vec3d& min, const Vec3d& max, const Matrix44& TM, const std::vector<string>& names, const int type, const int groupId, const float width) {
    return AddArea(min, max, TM, names, type, groupId, width);
}

//////////////////////////////////////////////////////////////////////////
IXArea* CXAreaMgr::CreateArea(const Vec3d& center, const float radius, const std::vector<string>& names, const int type, const int groupId, const float width) {
