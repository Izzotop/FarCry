...
class CScriptObjectFireParam : public _ScriptableEx<CScriptObjectFireParam> {
public:
...
class CScriptObjectWeaponClass : public _ScriptableEx<CScriptObjectWeaponClass>, public IScriptObjectSink {
public:
