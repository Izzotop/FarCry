...
int CScriptObjectUI::Create(CUISystem* pUISystem) {
    ...
    pScriptSystem->SetGlobalTonullptr("UI");
...
int CScriptObjectUI::SetBackgroundColor(IFunctionHandler* pH) {
    ...
    if ((pH->GetParamCount() == 1) && (pH->GetParamType(1) == svtString)) {
        ...
        m_pScriptSystem->RaiseError("UI:SetBackgroundColor() Wrong type in parameter 1! Expected 'String' or 'Number', but found '%s'!",
...
int CScriptObjectUI::SetMouseCursorColor(IFunctionHandler* pH) {
    ...
    if ((pH->GetParamCount() == 1) && (pH->GetParamType(1) == svtString)) {
        ...
        m_pScriptSystem->RaiseError("UI:SetMouseCursorColor() Wrong type in parameter 1! Expected 'String' or 'Number', but found '%s'!",
                                    GET_SCRIPT_TYPE_STRING(pH->GetParamType(1)));
