...
int CXGame::CreatePhysicalEntity(void* pForeignData, int iForeignData, int iForeignFlags) {
    ...
    case 0:
        return ((IEntity*)pForeignData)->CreatePhysicalEntityCallback(iForeignFlags); // CEntity
    case 1:
        ((IEntityRender*)pForeignData)->Physicalize(true);
        return 1; // CBrush
    case 2:
        return m_pSystem->GetI3DEngine()->PhysicalizeStaticObject(pForeignData, iForeignData, iForeignFlags); // CStatObjInst
    }
    return 0;
}
...
int CXGame::DestroyPhysicalEntity(IPhysicalEntity* pent) {
    ...
    case 0:
        return ((IEntityRender*)pfd.pForeignData)->DestroyPhysicalEntityCallback(pent); // CEntity
    case 1:
        ((IEntityRender*)pfd.pForeignData)->DestroyPhysicalEntityCallback(pent);
        return 1; // CBrush
    case 2:
        return 2; // CStatObjInst
    }
    return 0;
}
...
const char* CXGame::GetForeignName(void* pForeignData, int iForeignData, int iForeignFlags) {
    if (pForeignData)
        ...
        case 1:
            return "Brush/StatObj";
        }
    return "Orphan Entity";
}

//////////////////////////////////////////////////////////////////////////
void CXGame::OnBBoxOverlap(IPhysicalEntity* pEntity, void* pForeignData, int iForeignData, IPhysicalEntity* pCollider, void* pColliderForeignData, int iColliderForeignData) {
