...
/**
 * Implementation of IServerSnooperSink::OnServerFound called when a server is found after a CXGame::RefreshServerList() call
 * @param ip address of the server
 * @param szServerInfoString stream sent by the server to identify himself
 * @param ping average latency of the server response
 */
