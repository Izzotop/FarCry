...
int CScriptObjectVehicle::SetDrivingParameters(IFunctionHandler* pH) {
    ...
    float pedal_speed = 10.0f, steer_speed = 25.0f, max_steer_v0 = 40.0f, max_steer_kv = 0.0f, steer_relaxation_v0 = 0.0f, steer_relaxation_kv = 5.0f, brake_vel_threshold = 1000,
          brake_axle_friction = 1000, max_steering_pedal = 0.15f, pedal_limit_speed = 10.0f;
    ...
    if (m_pVehicle)
        m_pVehicle->SetDrivingParams(pedal_speed, steer_speed, max_steer_v0, max_steer_kv, steer_relaxation_v0, steer_relaxation_kv, brake_vel_threshold, brake_axle_friction,
                                     steer_speed_valScale, steer_speed_min, max_steering_pedal, pedal_limit_speed, fhandbrakevalue, fmaxbrakingfrictionnodriver,
                                     fhandbrakevaluenodriver, fstabilizejump, fsteerspeedscale, fsteerspeedscalemin);
