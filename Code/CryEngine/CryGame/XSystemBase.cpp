...
bool CXSystemBase::LoadLevelEntities(SMissionInfo& missionInfo) {
    ...
    m_pGame->GetScriptSystem()->SetGlobalTonullptr("Mission");
...
bool CXSystemBase::LoadLevelCommon(SMissionInfo& missionInfo) {
    ...
    if (missionInfo.bEditor) {
        ...
        if (pAISystem) {
            ...
            //////////////////////////////////////////////////////////////////////////
            pAISystem->GetAutoBalanceInterface()->SetMultipliers(m_pGame->cv_game_Accuracy->GetFVal(), m_pGame->cv_game_Aggression->GetFVal(), m_pGame->cv_game_Health->GetFVal());
        }
