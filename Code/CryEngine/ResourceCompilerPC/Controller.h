...
public:
    ...
    struct PQLog {
        ...
        string toString() const {
            return "{pos:" + CryStringUtils::toString(vPos) + ", rot=" + CryStringUtils::toString(vRotLog) + "}";
        }
...
public:
    bool operator()(const IController_AutoPtr& a, const IController_AutoPtr& b) {
        assert(a != (IController*)nullptr && b != (IController*)nullptr);
        return a->GetID() < b->GetID();
    }
    bool operator()(const IController_AutoPtr& a, unsigned nID) {
        assert(a != (IController*)nullptr);
        return a->GetID() < nID;
    }
};
