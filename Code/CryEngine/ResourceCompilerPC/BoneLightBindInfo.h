...
public:
    ...
    // if the buffer is nullptr, and bSave is true, returns the required buffer size
    ...
    const char* getLightImageCStr() const {
        return m_strLightImage.c_str();
    }
