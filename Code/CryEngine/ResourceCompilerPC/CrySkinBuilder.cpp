...
CrySkinBuilder::CrySkinBuilder(const ICrySkinSource* pGeometry) : m_arrSmoothVertHitCount("CrySkinBuilder.arrSmoothVertHitCount"), CrySkinBuilderBase(pGeometry) {
