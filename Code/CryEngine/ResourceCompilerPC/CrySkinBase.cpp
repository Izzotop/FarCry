...
CrySkinBase::CrySkinBase() : m_numBones(0), m_arrVertices("CrySkin*.Vertices"), m_arrAux("CrySkin*.Aux"), m_numSkipBones(0), m_numDests(0) {}
...
unsigned CrySkinBase::Serialize_PC(bool bSave, void* pStream, unsigned nBufSize) {
    ...
    unsigned nSizeRequired =
        ...
        sizeof(SerialHeader) + nSizeAuxInts + sizeof(Vertex) * Header.numVertices;
