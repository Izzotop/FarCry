...
bool CXFile::IsOutOfDate(const char* pFileName1, const char* pMasterFile) {
    ...
    HANDLE status1 = CreateFile(pFileName1, GENERIC_READ, FILE_SHARE_READ, nullptr, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, nullptr);

    HANDLE status2 = CreateFile(pMasterFile, GENERIC_READ, FILE_SHARE_READ, nullptr, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, nullptr);
...
int CXFile::LoadInMemory(const char* filename, void** bufferptr) {
    ...
    bbp[length] = 0; // nullptr terminated
    *bufferptr = buffer;
    return (length);
}
