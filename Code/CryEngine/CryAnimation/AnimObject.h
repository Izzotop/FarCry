...
public:
    ...
    struct Node : public ICryBone {
        ...
        virtual Vec3 GetBoneAxis(char cAxis) {
            ...
            case 0:
                return Vec3(m_tm(0, 0), m_tm(1, 0), m_tm(2, 0));
            case 1:
                return Vec3(m_tm(0, 1), m_tm(1, 1), m_tm(2, 1));
        ...
        virtual ICryBone* GetParent() {
            return m_parent;
        };
        virtual const Matrix44& GetRelativeMatrix() {
            return m_tm;
        };
        virtual const Matrix44& GetAbsoluteMatrix() {
            return m_tm;
        }; //[Timur] Wrong implementation.
           //////////////////////////////////////////////////////////////////////////
    };
    ...
    //! Sets current animation. (Can be nullptr).
    ...
    virtual Vec3 GetTPVWeaponHelper(const char* szHelperName, ObjectBindingHandle pInfo) {
        return Vec3(0, 0, 0);
    };
...
private:
    ...
    struct AnimationSet : public ICryAnimationSet {
        ...
        virtual int Count() {
            return (int)obj->m_animations.size();
        };
    ...
    struct SCharModel : public ICryCharModel {
        ...
        virtual const char* GetBoneName(int nId) const {
            return pAnimObject->GetNodeName(nId);
        }
        ...
        virtual int GetBoneByName(const char* szName) {
            return pAnimObject->FindNodeByName(szName);
        }
        ...
        virtual int NumBones() const {
            return pAnimObject->GetNumNodes();
        };

        //! returns the file name of the character model
        virtual const char* GetFileName() {
            return pAnimObject->GetFileName();
        }
