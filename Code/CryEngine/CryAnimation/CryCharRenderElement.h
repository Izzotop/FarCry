...
public:
    ...
    CLeafBuffer* getLeafBuffer() {
        return m_pLeafBuffer;
    }

    int getVertexFormat() {
        return m_pLeafBuffer->m_nVertexFormat;
    }

    void update(bool bLock, bool bCopyToVideoBuffer);

    void lock(bool bCopyToVideoBuffer) {
        update(true, bCopyToVideoBuffer);
    }
    void unlock(bool bCopyToVideoBuffer) {
        update(false, bCopyToVideoBuffer);
    }
