...
protected:
    ...
    struct SAnimFile {
        ...
        SAnimFile(const string& fileName, const char* szAnimName, unsigned animflags) : strFileName(fileName), strAnimName(szAnimName), nAnimFlags(animflags) {}
    ...
    string getCCGFilePath() {
        return m_bExtCCG ? m_strGeomFileNameNoExt + ".ccg" : "CCGF_CACHE\\" + m_strGeomFileNameNoExt + ".ccg";
    }
