...
//
class CCryModEffAnimation : public _i_reference_target_t {
protected:
    float m_fAnimTime;
    int m_nAnimId;
...
public:
    class Validator {
    public:
        Validator(CCryModEffAnimation* pParent) : m_pParent(pParent) {
    ...
    string dump();
    unsigned getStartAnimFlags() const {
        return m_nStartAnimFlags;
    }
    ...
    float GetTimeTillEnd() {
        return m_fStopTime - m_fAnimTime;
    }
