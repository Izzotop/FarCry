...
#define DECLARE_INT_VARIABLE_IMMEDIATE(_var, _default, _comment)                                                                                                                   \
    m_##_var = _default;                                                                                                                                                           \
    m_p_##_var = attach((#_var), &(m_##_var), _comment, VF_CHEAT | CVF_CHANGE_SOURCE);
#define DECLARE_INT_VARIABLE_IMMEDIATE_DUMP(_var, _default, _comment)                                                                                                              \
    m_##_var = _default;                                                                                                                                                           \
    m_p_##_var = attach((#_var), &(m_##_var), _comment, VF_DUMPTODISK);
#define DECLARE_STRING_VARIABLE(_var, _default)                                                                                                                                    \
    m_##_var = pConsole->CreateVariable(#_var, (_default), VF_CHEAT);                                                                                                              \
    assert(m_##_var)
#define DECLARE_INT_VARIABLE(_var, _default) m_##_var = declare(#_var, _default, VF_CHEAT);
#define DECLARE_FLOAT_VARIABLE(_var, _default, _comment)                                                                                                                           \
    m_##_var = pConsole->CreateVariable(#_var, (#_default), VF_CHEAT, _comment);                                                                                                   \
    assert(m_##_var)
#define DECLARE_FLOAT_VARIABLE_DUMP(_var, _default, _comment)                                                                                                                      \
    m_##_var = pConsole->CreateVariable(#_var, (#_default), VF_DUMPTODISK, _comment);                                                                                              \
    assert(m_##_var)
