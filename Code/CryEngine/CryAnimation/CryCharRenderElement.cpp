...
CryCharRenderElement::CryCharRenderElement() : m_pLeafBuffer(nullptr), m_nLeafBufferLastRenderFrame(0), m_numVertBufVertices(0) {}
...
void CryCharRenderElement::create(int nVertCount, const struct_VERTEX_FORMAT_P3F_COL4UB_TEX2F* pSourceData, const char* szSource, unsigned numMaterials, bool bOnlyVideoBuffer) {
    ...
    m_pLeafBuffer = g_GetIRenderer()->CreateLeafBufferInitialized((void*)pSourceData, nVertCount, VERTEX_FORMAT_P3F_COL4UB_TEX2F, nullptr, 0, R_PRIMV_TRIANGLES, szSource, eBT_Dynamic,
                                                                  numMaterials, 0, nullptr, nullptr, bOnlyVideoBuffer);
