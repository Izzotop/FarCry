...
class CryModel : public CryModelAnimationContainer {
...
public:
    ...
    unsigned numLODs() const {
        return (unsigned)m_arrGeomInfo.size();
    }
    ...
    unsigned numLocalBoneLights() const {
        return (unsigned)m_arrLocalBoneLights.size();
    }
    unsigned numGlobalBoneLights() const {
        return (unsigned)m_arrGlobalBoneLights.size();
    }
    unsigned numBoneLights() const {
        return numLocalBoneLights() + numGlobalBoneLights();
    }
    ...
    CBoneLightBindInfo& getLocalBoneLight(unsigned i) {
        return m_arrLocalBoneLights[i];
    }
    CBoneLightBindInfo& getGlobalBoneLight(unsigned i) {
        return m_arrGlobalBoneLights[i];
    }
...
public:
    ...
    float getStaticBSphereRadius() {
        return m_fStaticBSphereRadius;
    }
    ...
    const MAT_ENTITY& getMaterial(unsigned i) const {
        return m_arrMaterials[i];
    }
    MAT_ENTITY& getMaterial(unsigned i) {
        return m_arrMaterials[i];
    }
...
protected: // static data
    ...
    // each array must end with the nullptr string, to mark its end
