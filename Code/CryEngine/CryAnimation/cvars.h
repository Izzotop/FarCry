...
#define DECLARE_FLOAT_VARIABLE_IMMEDIATE(_var, _default)                                                                                                                           \
    float m_##_var;                                                                                                                                                                \
    float _var() const { return m_##_var; }
#define DECLARE_STRING_VARIABLE(_var, _default)                                                                                                                                    \
    ICVar* m_##_var;                                                                                                                                                               \
    const char* _var() { return m_##_var ? m_##_var->GetString() : _default; }
#define DECLARE_INT_VARIABLE(_var, _default)                                                                                                                                       \
    ICVar* m_##_var;                                                                                                                                                               \
    int _var() { return m_##_var->GetIVal(); }
#define DECLARE_FLOAT_VARIABLE(_var, _default, _comment)                                                                                                                           \
    ICVar* m_##_var;                                                                                                                                                               \
    float _var() { return m_##_var->GetFVal(); }
