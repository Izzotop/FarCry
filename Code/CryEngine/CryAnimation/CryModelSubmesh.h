...
class CryModelSubmesh : public ICryCharSubmesh,      // interface to the CryEngine
...
public:
    ...
    CryModel* GetCryModel() {
        return m_pMesh;
    }
    const CryModel* GetCryModel() const {
        return m_pMesh;
    }
    ...
    enum { FLAG_DEFORM_UPDATE_TANGENTS = 1, FLAG_DEFORM_UPDATE_NORMALS = 1 << 1, FLAG_DEFORM_UPDATE_VERTICES = 1 << 2, FLAG_DEFORM_FORCE_UPDATE = 1 << 3 };
