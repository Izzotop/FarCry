...
protected:
    unsigned numMeshIndices() {
        return m_nUsedMeshVertices;
    }
    unsigned numMeshVertices() {
        return m_pLeafBuffer->m_SecVertCount;
    }
