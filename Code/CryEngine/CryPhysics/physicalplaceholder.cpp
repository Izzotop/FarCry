...
int CPhysicalPlaceholder::SetParams(pe_params* _params) {
    ...
    if (_params->type == pe_params_pos::type_id) {
        ...
        if (!is_unused(params->pos) | !is_unused(params->q) | !is_unused(params->scale) | (intptr_t)params->pMtx3x3 | (intptr_t)params->pMtx3x3T | (intptr_t)params->pMtx4x4 |
            (intptr_t)params->pMtx4x4T)
