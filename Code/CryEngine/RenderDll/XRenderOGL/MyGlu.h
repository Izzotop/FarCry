...
int APIENTRY gluProject(GLdouble objx, GLdouble objy, GLdouble objz, const GLdouble modelMatrix[16], const GLdouble projMatrix[16], const GLint viewport[4], GLdouble* winx,
                        GLdouble* winy, GLdouble* winz);

int APIENTRY gluUnProject(GLdouble winx, GLdouble winy, GLdouble winz, const GLdouble modelMatrix[16], const GLdouble projMatrix[16], const GLint viewport[4], GLdouble* objx,
...
GLUquadric* APIENTRY gluNewQuadric();
...
GLUnurbs* APIENTRY gluNewNurbsRenderer();
...
void APIENTRY gluNurbsSurface(GLUnurbs* nobj, GLint sknot_count, float* sknot, GLint tknot_count, GLfloat* tknot, GLint s_stride, GLint t_stride, GLfloat* ctlarray, GLint sorder,
...
typedef void(CALLBACK* GLUtessEndProc)();
...
#define GLU_TESS_END 100102       /* void (CALLBACK*)()            */
...
#define GLU_TESS_COMBINE                                                                                                                                                           \
    100105 /* void (CALLBACK*)(GLdouble  coords[3],                                                                                                                                \
                               void      *data[4],                                                                                                                                 \
                               GLfloat   weight[4],                                                                                                                                \
                               void      **dataOut)     */
#define GLU_TESS_BEGIN_DATA                                                                                                                                                        \
    100106 /* void (CALLBACK*)(GLenum    type,                                                                                                                                     \
                               void      *polygon_data) */
#define GLU_TESS_VERTEX_DATA                                                                                                                                                       \
    100107                       /* void (CALLBACK*)(void      *data,                                                                                                              \
                                                     void      *polygon_data) */
#define GLU_TESS_END_DATA 100108 /* void (CALLBACK*)(void      *polygon_data) */
#define GLU_TESS_ERROR_DATA                                                                                                                                                        \
    100109 /* void (CALLBACK*)(GLenum    errno,                                                                                                                                    \
                               void      *polygon_data) */
#define GLU_TESS_EDGE_FLAG_DATA                                                                                                                                                    \
    100110 /* void (CALLBACK*)(GLboolean boundaryEdge,                                                                                                                             \
                               void      *polygon_data) */
#define GLU_TESS_COMBINE_DATA                                                                                                                                                      \
    100111 /* void (CALLBACK*)(GLdouble  coords[3],                                                                                                                                \
                               void      *data[4],                                                                                                                                 \
                               GLfloat   weight[4],                                                                                                                                \
                               void      **dataOut,                                                                                                                                \
                               void      *polygon_data) */
