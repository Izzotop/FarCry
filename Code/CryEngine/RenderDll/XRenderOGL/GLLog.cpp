...
void __stdcall lglEnd() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glEnd");
    tglEnd();
}
void __stdcall lglEndList() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glEndList");
    tglEndList();
}
...
void __stdcall lglFinish() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glFinish");
    tglFinish();
}
void __stdcall lglFlush() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glFlush");
    tglFlush();
}
...
void __stdcall lglLoadIdentity() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glLoadIdentity");
    tglLoadIdentity();
}
...
void __stdcall lglMaterialfv(GLenum face, GLenum pname, const GLfloat* params) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%s, %s, [%.3f %.3f %.3f %.3f])\n", "glMaterialfv", senFace(face), senMaterialv(pname), params[0], params[1], params[2],
                  params[3]);
...
void __stdcall lglPopAttrib() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glPopAttrib");
    tglPopAttrib();
}
void __stdcall lglPopClientAttrib() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glPopClientAttrib");
    tglPopClientAttrib();
}
void __stdcall lglPopMatrix() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glPopMatrix");
    tglPopMatrix();
}
void __stdcall lglPopName() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glPopName");
    tglPopName();
}
...
void __stdcall lglTexEnvfv(GLenum target, GLenum pname, const GLfloat* params) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%s, %s, (%.3f, %.3f, %.3f, %.3f))\n", "glTexEnvfv", senTextureEnvTarget(target), senTextureEnvfPName(pname), params[0], params[1],
                  params[2], params[3]);
...
void __stdcall lglTexEnviv(GLenum target, GLenum pname, const GLint* params) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%s, %s, (%i, %i, %i, %i))\n", "glTexEnviv", senTextureEnvTarget(target), senTextureEnvfPName(pname), params[0], params[1],
                  params[2], params[3]);
...
void __stdcall lglTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid* pixels) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%s, %d, %s, %d, %d, %d, %s, %s, 0x%x)\n", "glTexImage2D", senTexTarg(target), level, senTexFormat(internalformat), width, height,
                  border, senTexFormat(format), senTexDataType(type), pixels);
...
HGLRC __stdcall lpwglGetCurrentContext() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "wglGetCurrentContext");
    return tpwglGetCurrentContext();
}
HDC __stdcall lpwglGetCurrentDC() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "wglGetCurrentDC");
...
void __stdcall lglCompressedTexImage2DARB(GLenum Parm0, GLint Parm1, GLenum Parm2, GLsizei Parm3, GLsizei Parm4, GLint Parm5, GLsizei Parm6, const GLvoid* Parm7) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%s, %d, %s, %d, %d, %d, %d, 0x%x)\n", "glCompressedTexImage2DARB", senTexTarg(Parm0), Parm1, senTexFormat(Parm2), Parm3, Parm4,
                  Parm5, Parm6, Parm7);
...
void __stdcall lglCompressedTexSubImage3DARB(GLenum Parm0, GLint Parm1, GLint Parm2, GLint Parm3, GLint Parm4, GLsizei Parm5, GLsizei Parm6, GLsizei Parm7, GLenum Parm8,
                                             GLsizei Parm9, const GLvoid* Parm10) {
...
void __stdcall lglUnlockArraysEXT() {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glUnlockArraysEXT");
    tglUnlockArraysEXT();
}
...
void __stdcall lglFlushVertexArrayRangeNV() {
...
void __stdcall lglCombinerParameterfvNV(GLenum pname, const GLfloat* params) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%d, (%.3f, %.3f, %.3f, %.3f))\n", "glCombinerParameterfvNV", pname - GL_CONSTANT_COLOR0_NV, params[0], params[1], params[2],
                  params[3]);
...
void __stdcall lglCombinerStageParameterfvNV(GLenum stage, GLenum pname, const GLfloat* params) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s (%d, %d, (%.3f, %.3f, %.3f, %.3f))\n", "glCombinerStageParameterfvNV", stage - GL_COMBINER0_NV, pname - GL_CONSTANT_COLOR0_NV,
...
void __stdcall lglCombinerOutputNV(GLenum stage, GLenum portion, GLenum abOutput, GLenum cdOutput, GLenum sumOutput, GLenum scale, GLenum bias, GLboolean abDotProduct,
...
HDC _stdcall lwglGetCurrentReadDCARB() {
...
void _stdcall lglEndOcclusionQueryNV() {
...
void _stdcall lglColorFragmentOp2ATI(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep,
                                     GLuint arg2Mod) {
    gRenDev->Logv(SRendItem::m_RecurseLevel, "%s\n", "glColorFragmentOp2ATI");
    tglColorFragmentOp2ATI(op, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod);
}
void _stdcall lglColorFragmentOp3ATI(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod,
...
void _stdcall lglAlphaFragmentOp3ATI(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3,
