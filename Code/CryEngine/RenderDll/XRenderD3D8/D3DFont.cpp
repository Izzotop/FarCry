...
bool CD3D8Renderer::FontUploadTexture(class CFBitmap* pBmp) {
    ...
    STexPic* tp = m_TexMan->CreateTexture(name, pBmp->GetWidth(), pBmp->GetHeight(), 1, flags, 0, (byte*)pBmp->GetData(), eTT_Base, -1.0f, -1.0f, 0, nullptr, 0, eTF_8888);
...
static int nBlendMatchTable[] = {
    ...
    D3DBLEND_INVSRCALPHA, D3DBLEND_DESTALPHA, D3DBLEND_INVDESTALPHA, D3DBLEND_DESTCOLOR,   D3DBLEND_INVDESTCOLOR,
};
