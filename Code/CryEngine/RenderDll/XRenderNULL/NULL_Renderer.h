...
/*
===========================================
The nullptrRenderer interface Class
===========================================
*/
...
//////////////////////////////////////////////////////////////////////
class CnullptrRenderer : public CRenderer {
    friend class CnullptrTexMan;
...
public:
    ...
    virtual char* GetVertexProfile(bool bSupported) {
        return "NONE";
    }
    virtual char* GetPixelProfile(bool bSupported) {
        return "NONE";
    }
...
extern CnullptrRenderer* gcpnullptr;

struct CnullptrTexUnit {
    int m_Bind;
    int m_Target;
    float m_fTexFilterLodBias;
};

class CnullptrTexMan : public CTexMan {
...
public:
    ...
    CnullptrTexMan() : CTexMan() {}
    virtual ~CnullptrTexMan();
    ...
    // tiago: added
    virtual void DrawMotionMap() {}
    virtual void DrawScreenContrastMap() {}
    virtual void DrawScreenColorTransferMap() {}
    ...
    static CnullptrTexUnit m_TUState[8];
