...
void CnullptrRenderer::EF_InitRandTables() {}

void CnullptrRenderer::EF_InitWaveTables() {}

void CnullptrRenderer::EF_InitEvalFuncs(int num) {}

int CnullptrRenderer::EF_RegisterFogVolume(float fMaxFogDist, float fFogLayerZ, CFColor color, int nIndex, bool bCaustics) {
    if (nIndex < 0) {
        SMFog Fog;
...
void CnullptrRenderer::EF_PipelineInit() {
    bool nv = 0;
...
void CnullptrRenderer::EF_ClearBuffers(bool bForce, float* Colors) {}

void CnullptrRenderer::EF_SetClipPlane(bool bEnable, float* pPlane, bool bRefract) {}

void CnullptrRenderer::EF_PipelineShutdown() {
    int i, j;
...
void CnullptrRenderer::EF_Release(int nFlags) {}

//==========================================================================

void CnullptrRenderer::EF_SetCameraInfo() {}

void CnullptrRenderer::EF_CalcObjectMatrix(CCObject* obj) {}

void CnullptrRenderer::EF_SetObjectTransform(CCObject* obj) {}

void CnullptrRenderer::EF_PreRender(int Stage) {}

//=======================================================================

void CnullptrRenderer::EF_Eval_DeformVerts(TArray<SDeform>* Defs) {}

void CnullptrRenderer::EF_Eval_TexGen(SShaderPass* sfm) {}

void CnullptrRenderer::EF_Eval_RGBAGen(SShaderPass* sfm) {}

void CnullptrRenderer::EF_EvalNormalsRB(SShader* ef) {}

//=================================================================================

void CnullptrRenderer::PS2SetCull(ECull eCull) {
    m_RP.m_eCull = eCull;
}
...
void CnullptrRenderer::EF_SetColorOp(byte co) {}
...
bool CnullptrRenderer::EF_ObjectChange(SShader* Shader, int nObject, CRendElement* pRE) {
    return true;
}

// Initialize of the new shader pipeline (only 2d)
void CnullptrRenderer::EF_Start(SShader* ef, SShader* efState, SRenderShaderResources* Res, CRendElement* re) {
    m_RP.m_Frame++;
}

// Initialize of the new shader pipeline
void CnullptrRenderer::EF_Start(SShader* ef, SShader* efState, SRenderShaderResources* Res, int numFog, CRendElement* re) {
    m_RP.m_Frame++;
}

void CnullptrRenderer::EF_CheckOverflow(int nVerts, int nInds, CRendElement* re) {}

//========================================================================================

void CnullptrRenderer::EF_LightMaterial(SLightMaterial* lm, int Flags) {}

//===================================================================================================

// Used for HW effectors for rendering of tri mesh (vertex array)
void CnullptrRenderer::EF_DrawIndexedMesh(int nPrimType) {}

void CnullptrRenderer::EF_FlushShader() {}

void CnullptrRenderer::EF_Flush() {}

void CnullptrRenderer::EF_EndEf3D(int nFlags) {
    m_RP.m_RealTime = iTimer->GetCurrTime();
    EF_RemovePolysFromScene();
    SRendItem::m_RecurseLevel--;
}

void CnullptrRenderer::EF_RenderPipeLine(void (*RenderFunc)()) {}

void CnullptrRenderer::EF_PipeLine(int nums, int nume, int nList, int nSortType, void (*RenderFunc)()) {}

void CnullptrRenderer::EF_DrawWire() {}

void CnullptrRenderer::EF_DrawNormals() {}

void CnullptrRenderer::EF_DrawTangents() {}

void CnullptrRenderer::EF_DrawDebugLights() {}

void CnullptrRenderer::EF_DrawDebugTools() {}

void CnullptrRenderer::EF_PrintProfileInfo() {}

int CnullptrRenderer::EF_Preprocess(SRendItemPre* ri, int nums, int nume) {
    return 0;
}

// double timeFtoI, timeFtoL, timeQRound;
// int sSome;
void CnullptrRenderer::EF_EndEf2D(bool bSort) {}
