...
CREScreenProcess::~CREScreenProcess(){SAFE_DELETE(m_pVars)};
...
int CREScreenProcess::mfSetParameter(int iProcess, int iParams, void* dwValue) {
    ...
    case SCREENPROCESS_SCREENTEX:
        switch (iParams) { SET_PARAMETER(SCREENPROCESS_ACTIVE, m_pVars->m_bScreenTexActive, bool, dwValue) }
        break;
...
void* CREScreenProcess::mfGetParameter(int iProcess, int iParams) {
    ...
    case SCREENPROCESS_CARTOON:
        switch (iParams) { RETURN_PARAMETER(SCREENPROCESS_ACTIVE, m_pVars->m_bCartoonActive) }
        break;
    ...
    case SCREENPROCESS_SCREENTEX:
        switch (iParams) { RETURN_PARAMETER(SCREENPROCESS_ACTIVE, m_pVars->m_bScreenTexActive) }
        break;
