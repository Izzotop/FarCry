...
#define SHADERSCHECK !defined(PS2) && !defined(GC) && !defined(nullptr_RENDERER)
...
public:
    ...
    // motion blur shaders
    void *m_pRCMotion, *m_pRCMotionAmount;
    void* m_pVPMotion;
    ...
    void *m_pRCGlareMap, *m_pRCGlareAmountMap, *m_pRCGlare, *m_pRCRenderModeCold, *m_pRCRenderModeAdv;
    ...
    // heatvision shaders
    void *m_pRCHeatVision, *m_pRCHeatSourceDecode;
    ...
    // cartoon shaders
    void *m_pRCCartoon, *m_pRCCartoonSilhouette;
    void* m_pVPCartoon;
    ...
    // fade process vars
    bool m_bFadeActive;
    float m_fFadeTime, m_fFadeCurrTime, m_fFadePreTime, m_fFadeCurrPreTime;

    color4f m_pFadeColor, m_pFadeCurrColor;
    ...
    int m_iMotionBlurType, m_iMotionBlurDisplace;
    ...
    bool m_bGlareActive;
    int m_iGlareBox, m_iGlareLumSize, m_iGlareSize;
    float m_fGlareAmount, m_fGlareThreshold, m_fGlareAmountDynamic, m_fGlareMaxAmount;
    color4f m_pCurrGlareMapConst, m_pCurrSaturation, m_pCurrContrast;
    // nightvision vars
    ...
    float m_fFlashBangTimeScale, m_fFlashBangTimeOut, m_fFlashBangFlashPosX, m_fFlashBangFlashPosY, m_fFlashBangFlashSizeX, m_fFlashBangFlashSizeY;
