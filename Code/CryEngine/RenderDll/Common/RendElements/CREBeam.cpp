...
bool CREBeam::mfCompile(SShader* ef, char* scr) {
    ...
    static tokenDesc commands[] = {
        {eModel, "Model"},       {eStartRadius, "StartRadius"}, {eEndRadius, "EndRadius"}, {eStartColor, "StartColor"},
        {eEndColor, "EndColor"}, {eLightStyle, "LightStyle"},   {eLength, "Length"},       {0, 0},
    };
