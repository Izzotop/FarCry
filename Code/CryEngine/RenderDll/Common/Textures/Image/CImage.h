...
struct SRGBPixel {
    ...
    bool eq(const SRGBPixel& p) const {
        return ((*(unsigned long*)this) & RGB_MASK) == ((*(unsigned long*)&p) & RGB_MASK);
    }
...
public:
    ...
    void mfSet_bps(int b) {
        m_Bps = b;
    }
    void mfSet_ImageSize(int Size) {
        m_ImgSize = Size;
    }
    int mfGet_ImageSize() {
        return m_ImgSize;
    ...
    EImFormat mfGetFormat() {
        return m_eFormat;
    }

    void mfSet_numMips(int num) {
        m_NumMips = num;
    }
    int mfGet_numMips() {
        return m_NumMips;
    }
    void mfSet_Flags(int Flags) {
        m_Flags |= Flags;
    }
    int mfGet_Flags() {
        return m_Flags;
    ...
    ///
    static EImFileError mfGet_error() {
        return m_eError;
    }
    ///
    static char* mfGet_error_detail() {
        return m_Error_detail ? m_Error_detail : (char*)"";
    }
