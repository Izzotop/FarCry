...
enum EResId { eRI_UNKNOWN = -1, eRI_BIN = 0, eRI_IMAGE = 1, eRI_MIPTEX = 2, eRI_SOUND = 3, eRI_MODEL = 4, eRI_PALETTE = 5 };

enum EArc { eARC_NONE = 0, eARC_RLE = 1, eARC_LZSS = 2 };
