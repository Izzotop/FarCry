...
enum EFogBlendComponents { eFBLC_None, eFBLC_OnlyColor, eFBLC_ColorAlpha, eFBLC_OnlyAlpha };
...
public:
...
#if !defined(PS2) && !defined(GC) && !defined(nullptr_RENDERER)
    ...
    virtual bool mfSet(bool bStat, SShaderPassHW* slw, int nFlags = VPF_SETPOINTERSFORSHADER) {
        return 0;
    }
    ...
    virtual void mfGatherFXParameters(const char* buf, SShaderPassHW* pSHPass, std::vector<SFXParam>& Params, std::vector<SFXSampler>& Samplers, std::vector<SFXTexture>& Textures,
                                      SShader* ef) = 0;
...
struct SParam {
    ...
    void mfOptimize() {
        if ((m_Comps[0] && m_Comps[0]->m_eType == EParamComp_ObjWave) || (m_Comps[1] && m_Comps[1]->m_eType == EParamComp_ObjWave) ||
            (m_Comps[2] && m_Comps[2]->m_eType == EParamComp_ObjWave) || (m_Comps[3] && m_Comps[3]->m_eType == EParamComp_ObjWave)) {
            m_Flags |= PF_DONTALLOW_DYNMERGE;
        } else if ((m_Comps[0] && m_Comps[0]->m_eType == EParamComp_PlantsTMoving) || (m_Comps[1] && m_Comps[1]->m_eType == EParamComp_PlantsTMoving) ||
                   (m_Comps[2] && m_Comps[2]->m_eType == EParamComp_PlantsTMoving) || (m_Comps[3] && m_Comps[3]->m_eType == EParamComp_PlantsTMoving)) {
            m_Flags |= PF_DONTALLOW_DYNMERGE;
        }

        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_WorldColor && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_WorldColor && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_WorldColor && (!m_Comps[3] || m_Comps[3]->m_eType == EParamComp_Opacity)) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_LightColor && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_LightColor && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_LightColor && (!m_Comps[3] || m_Comps[3]->m_eType == EParamComp_Opacity)) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_DiffuseColor && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_DiffuseColor && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_DiffuseColor && (!m_Comps[3] || m_Comps[3]->m_eType == EParamComp_Opacity)) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_SpecLightColor && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_SpecLightColor && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_SpecLightColor && (!m_Comps[3] || m_Comps[3]->m_eType == EParamComp_Opacity)) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_SunColor && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_SunColor && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_SunColor && !m_Comps[3]) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_AmbLightColor && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_AmbLightColor && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_AmbLightColor && m_Comps[3] && m_Comps[3]->m_eType == EParamComp_Opacity) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_ObjWave && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_ObjWave && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_Bending) {
            m_Flags |= PF_CANMERGED;
            return;
        }

        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_PlantsTMoving && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_PlantsTMoving && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_PlantsTMoving && m_Comps[3] && m_Comps[3]->m_eType == EParamComp_PlantsTMoving) {
            m_Flags |= PF_CANMERGED;
            return;
        }

        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_OSLightPos && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_OSLightPos && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_OSLightPos) {
            if (!m_Comps[3] || m_Comps[3]->m_eType == EParamComp_OSLightPos || (m_Comps[3]->m_eType == EParamComp_Const && m_Comps[3]->mfGet() == 1.0f))
                m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_SLightPos && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_SLightPos && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_SLightPos && m_Comps[3] && m_Comps[3]->m_eType == EParamComp_MinLightDistance) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_LightOcclusion && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_LightOcclusion && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_LightOcclusion && m_Comps[3] && m_Comps[3]->m_eType == EParamComp_LightOcclusion) {
            m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_OSCameraPos && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_OSCameraPos && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_OSCameraPos) {
            if (!m_Comps[3] || m_Comps[3]->m_eType == EParamComp_OSCameraPos || (m_Comps[3]->m_eType == EParamComp_Const && m_Comps[3]->mfGet() == 1.0f))
                m_Flags |= PF_CANMERGED;
            return;
        }
        if (m_Comps[0] && m_Comps[0]->m_eType == EParamComp_SCameraPos && m_Comps[1] && m_Comps[1]->m_eType == EParamComp_SCameraPos && m_Comps[2] &&
            m_Comps[2]->m_eType == EParamComp_SCameraPos && m_Comps[3] && m_Comps[3]->m_eType == EParamComp_MinDistance) {
            m_Flags |= PF_CANMERGED;
            return;
        }
                    ...
                    if (pcLS->m_bInv) {
                        if (m_Comps[2] && m_Comps[2]->m_eType == EParamComp_Const) {
                            ...
                            if (pcCS->m_Val == 0.5f) {
                                ...
                                if (!m_Comps[3])
                                    bMerge = true;
                                else if (m_Comps[3]->m_eType == EParamComp_Const) {
...
struct SShader : public IShader {
    ...
    virtual IShader* GetTemplate(int num) {
        return (IShader*)mfGetTemplate(num);
    }
    virtual SEfTemplates* GetTemplates() {
        return m_Templates;
    }
    virtual int GetTexId();
    virtual unsigned int GetUsedTextureTypes();
    virtual uint GetPreprocessFlags() {
        return m_nPreprocess;
    }
    virtual int GetVertexFormat() {
        return m_VertexFormatId;
    }
    ...
    SShader* mfGetTemplate(int num) {
        if (m_Templates) {
            ...
            else if (m_Templates->m_Preferred)
...
inline void SParamComp_Matrix::mfCopy(const SParamComp* p) {
    SParamComp_Matrix* src = (SParamComp_Matrix*)p;
    m_eType = src->m_eType;
    m_Offs = src->m_Offs;
    m_Transforms.Copy(src->m_Transforms);
