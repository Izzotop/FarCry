...
static ushort sFlareIndices[18][3] = {
    {0, 4, 5}, {0, 5, 6}, {0, 6, 7},  {0, 7, 1},   {1, 7, 8},   {1, 8, 9},  {15, 4, 0},  {15, 0, 3},  {3, 0, 1},
    {3, 1, 2}, {2, 1, 9}, {2, 9, 10}, {14, 15, 3}, {14, 3, 13}, {13, 3, 2}, {13, 2, 12}, {12, 2, 11}, {11, 2, 10},
};
...
void SEvalFuncs_RE::FlareDeform(SDeform* df) {
    ...
    //          this is nullptr for C:\MASTERCD\Objects\glm\ww2_indust_set1\lights\light_indust3\light_indust3.cgf
    if (!vbSrc)
        return;
...
void SEvalFuncs_RE::ETC_ShadowMap(int ns) {
    ...
    // setup projection
    gRenDev->SetupShadowOnlyPass(ns, pShadowMapFrustum, &((*lsources)[nsFrust].m_vProjTranslation), (*lsources)[nsFrust].m_fProjScale, vObjTrans, 1.f, Vec3d(0, 0, 0), m);
}
