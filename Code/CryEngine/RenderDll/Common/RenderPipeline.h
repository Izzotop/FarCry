...
struct SRendItem : SRendItemPre {
    ...
    static void mfComputeTangent(const Vec3d& v0, const Vec3d& v1, const Vec3d& v2, const float t0[2], const float t1[2], const float t2[2], Vec3d& tangent, Vec3d& binormal,
                                 float& sign, Vec3d& face_normal);
...
#define STARTPROFILE(Item)                                                                                                                                                         \
    {                                                                                                                                                                              \
        ticks(Item.m_fTime);                                                                                                                                                       \
        Item.m_Nums++;                                                                                                                                                             \
    }
#define ENDPROFILE(Item)                                                                                                                                                           \
    { unticks(Item.m_fTime); }
