...
public:
    ...
    D3D2DTextureLocker(LPDIRECT3DTEXTURE9 pTexture) : m_pTexture(pTexture), m_pDataFormat(nullptr) {
        m_pTexture->AddRef();
...
public:
    D3D2DSurfaceLocker(LPDIRECT3DSURFACE9 pSurface) : m_pSurface(pSurface), m_pDataFormat(nullptr) {
        m_pSurface->AddRef();
        m_bLocked = false;
...
public:
    ...
    static LPDIRECT3DTEXTURE9 CreateNormalMap(LPDIRECT3DDEVICE9 pD3DDev, LPDIRECT3DTEXTURE9 pSource, STexPic* ti, bool bMips, D3DXVECTOR3 Scale, D3DFORMAT Format = D3DFMT_Q8W8V8U8,
