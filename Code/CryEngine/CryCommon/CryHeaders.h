...
//////////////////////////////////////////////////////////////////////////
enum TextureMappingType { TEXMAP_NORMAL = 0, TEXMAP_ENVIRONMENT, TEXMAP_SCREENENVIRONMENT, TEXMAP_CUBIC, TEXMAP_AUTOCUBIC };
...
#define __copy3(MEMBER)                                                                                                                                                            \
    left.MEMBER[0] = right.MEMBER[0];                                                                                                                                              \
    left.MEMBER[1] = right.MEMBER[1];                                                                                                                                              \
    left.MEMBER[2] = right.MEMBER[2];
...
//////////////////////////////////////////////////////////////////////////
enum CryCustomAttribFlags { CATYPE_INT, CATYPE_FLOAT, CATYPE_BOOL, CATYPE_STRING };
...
enum CtrlFlags { CTRL_ORT_CYCLE = 0x01, CTRL_ORT_LOOP = 0x02 };
...
// Helper Chunk Header
//========================================
enum HelperTypes { HP_POINT = 0, HP_DUMMY = 1, HP_XREF = 2, HP_CAMERA = 3 };
...
// immediately followed by the name (nullptr-terminated, variable-length string) of the morph target.
...
struct SBoneInitPosMatrix {
    ...
    const Vec3& getOrt(int nOrt) const {
        return *(const Vec3*)(mx[nOrt]);
    }
};
