...
struct IStatObj : public IBindable {
    ...
    // Return Value:
    //     A static object with the desired LOD. The value nullptr will be return if
    ...
    //     specified as parameter was out of range, the value nullptr will be
    //     returned.
    // Summary:
    ...
    // Return Value:
    //     A nullptr terminated string which contain the folder name of the object.
    virtual const char* GetFolderName() = 0;

    // Summary:
    //     Returns the filename of the object
    // Return Value:
    //     A nullptr terminated string which contain the filename of the object.
    virtual const char* GetFileName() = 0;

    // Summary:
    //     Returns the name of the geometry
    // Return Value:
    //     A nullptr terminated string which contains the name of the geometry
    ...
    //     the cgf file.
    // Arguments:
    //     szHelperName - A nullptr terminated string holding the name of the helper
    // Return Value:
