 ...
 */
template <typename F> ILINE Vec3_tpl<F> Origin_Triangle2D(const Triangle_tpl<F>& t) {
    Vec3_tpl<F> a = t.v0;
    Vec3_tpl<F> b = t.v1;
    Vec3_tpl<F> c = t.v2;
 ...
 */
template <typename F> ILINE F Point_Triangle(const Vec3_tpl<F>& p, const Triangle_tpl<F>& t) {
 ...
 */
template <typename F> ILINE F Point_Triangle(const Vec3_tpl<F>& p, const Triangle_tpl<F>& t, Vec3_tpl<F>& output) {
    // translate triangle into origin
    Vec3_tpl<F> a = t.v0 - p;
    Vec3_tpl<F> b = t.v1 - p;
    Vec3_tpl<F> c = t.v2 - p;
...
//  float result = Distance::Point_Triangle( pos, triangle );
//----------------------------------------------------------------------------------
template <typename F> ILINE F Sphere_Triangle(const Sphere& s, const Triangle_tpl<F>& t) {
...
template <typename F> ILINE F Sphere_Triangle(const Sphere& s, const Triangle_tpl<F>& t, Vec3_tpl<F>& output) {
