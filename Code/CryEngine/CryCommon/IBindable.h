...
struct IBindable {
    ...
    enum ECharShaderFlags { FLAGS_SET_SHADER_RECURSIVE = 1 };
    ...
    //     object, else the nullptr value will be returned.
    ...
    //     a character instance, else the nullptr value will be returned.
