...
struct ILMSerializationManager {
    ...
    //!
    virtual void AddTexCoordData(const std::vector<struct TexCoord2Comp>& vTexCoords, int iGLM_ID_UsingTexCoord, const DWORD indwHashValue,
                                 const std::vector<std::pair<EntityId, EntityId>>& rOcclIDs) = 0;
