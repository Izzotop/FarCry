...
public:
    ...
    XmlNodeRef(int dummy) : p(nullptr) {}
    ...
    friend bool operator==(const XmlNodeRef& p1, int dummy);
    friend bool operator!=(const XmlNodeRef& p1, int dummy);
    friend bool operator==(int dummy, const XmlNodeRef& p1);
    friend bool operator!=(int dummy, const XmlNodeRef& p1);
};
...
public:
    ...
    void setAttr(const char* key, unsigned long value) {
        setAttr(key, (unsigned int)value);
    };
...
inline bool operator==(const XmlNodeRef& p1, int dummy) {
    return p1.p == nullptr;
}
...
inline bool operator==(int dummy, const XmlNodeRef& p1) {
    return p1.p == nullptr;
}
