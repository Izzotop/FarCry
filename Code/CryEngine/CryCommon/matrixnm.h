...
public:
    ...
    ftype* operator[](int iRow) const {
        return data + iRow * nCols;
    }
...
template <class ftype> matrix_product_tpl<ftype> operator*(const matrix_tpl<ftype>& op1, const matrix_tpl<ftype>& op2) {
...
template <class ftype> matrix_tpl<ftype>& operator*=(matrix_tpl<ftype>& op1, ftype op2) {
...
template <class ftype1, class ftype2> matrix_tpl<ftype1>& operator+=(matrix_tpl<ftype1>& op1, const matrix_tpl<ftype2>& op2) {
    for (int i = op1.nRows * op1.nCols - 1; i >= 0; i--)
...
template <class ftype1, class ftype2> matrix_tpl<ftype1> operator+(const matrix_tpl<ftype1>& op1, const matrix_tpl<ftype2>& op2) {
...
template <class ftype1, class ftype2, class ftype3> ftype3* mul_vector_by_matrix(const matrix_tpl<ftype1>& mtx, const ftype2* psrc, ftype3* pdst) {
    int i, j;
