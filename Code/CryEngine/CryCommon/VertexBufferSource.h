...
struct VertexBufferSource {
    VertexBufferSource()
        : numMaterials(0), pMaterials(nullptr), pShaders(nullptr), pMats(nullptr), pOrFlags(nullptr), pAndFlags(nullptr), numPrimGroups(0), pPrimGroups(nullptr), numIndices(0), pIndices(nullptr),
          numVertices(0), pVertices(nullptr), pUVs(nullptr), nREFlags(0) {}
    ...
    // these parameters may be nullptr
