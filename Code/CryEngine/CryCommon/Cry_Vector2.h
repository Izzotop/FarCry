...
template <class F> struct Vec2_tpl {
    ...
    template <class F1> Vec2_tpl(const Vec2_tpl<F1>& src) {
        x = src.x;
        y = src.y;
    }
    template <class F1> explicit Vec2_tpl(const Vec3_tpl<F1>& src) {
        x = src.x;
        y = src.y;
    }
    ...
    Vec2_tpl& operator=(const Vec2_tpl<F>& src) {
        x = src.x;
        y = src.y;
        return *this;
    }
    template <class F1> Vec2_tpl& operator=(const Vec2_tpl<F1>& src) {
        x = src.x;
        y = src.y;
        return *this;
    }
    template <class F1> Vec2_tpl& operator=(const Vec3_tpl<F1>& src) {
        x = src.x;
        y = src.y;
        return *this;
    }
...
template <class F1, class F2> F1 operator*(const Vec2_tpl<F1>& op1, const Vec2_tpl<F2>& op2) {
...
template <class F1, class F2> Vec2_tpl<F1> operator+(const Vec2_tpl<F1>& op1, const Vec2_tpl<F2>& op2) {
...
template <class F1, class F2> Vec2_tpl<F1>& operator+=(Vec2_tpl<F1>& op1, const Vec2_tpl<F2>& op2) {
    op1.x += op2.x;
    op1.y += op2.y;
    return op1;
}
