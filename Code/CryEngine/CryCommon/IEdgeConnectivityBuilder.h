...
public:
    ...
    const virtual CStencilShadowConnectivity* GetInternalRepresentation() const = 0;
...
public:
    ...
    //! /return
    virtual IStencilShadowConnectivity* ConstructConnectivity() = 0;

    //! returns the number of single (with no pair faces found) or orphaned edges
    //! /return
    virtual unsigned numOrphanedEdges() const = 0;
...
public:
    ...
    //!
    //! /return
    virtual unsigned numShadowVolumeVertices() const = 0;
    ...
    //! /return
    virtual unsigned numShadowVolumeIndices() const = 0;
