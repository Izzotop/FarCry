...
#define CS_MPEGACCURATE                                                                                                                                                            \
    0x00020000 /* For CS_Stream_OpenFile - for accurate CS_Stream_GetLengthMs/CS_Stream_SetTime.  WARNING, see CS_Stream_OpenFile for inital opening time performance issues. */
...
#define CS_NONBLOCKING                                                                                                                                                             \
    0x01000000 /* For CS_Stream_OpenFile - Causes stream to open in the background and not block the foreground app - stream functions only work when ready.  Poll any stream      \
                  function determine when it IS ready. */
