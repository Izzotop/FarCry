...
struct CryCharFxTrailParams {
    ...
    CryCharFxTrailParams(int nBone, int nTextureId = -1, float fLength = 0.25f, const Vec3d& vStart = Vec3d(0, 0, 0), const Vec3d& vEnd = Vec3d(0, 0, 1),
                         unsigned numMaxQuads = 24) {
        this->nBone = nBone;
