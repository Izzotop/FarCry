...
template <class T> struct color4 {
    ...
    inline unsigned int pack8() {
        return pack_rgb332();
    }
    inline unsigned int pack12() {
        return pack_argb4444();
    }
    inline unsigned int pack15() {
        return pack_rgb555();
    }
    inline unsigned int pack16() {
        return pack_rgb565();
    }
    inline unsigned int pack24() {
        return pack_rgb888();
    }
    inline unsigned int pack32() {
        return pack_argb8888();
    }
...
///////////////////////////////////////////////
template <class T> inline color4<T>::color4(const T* p_elts) {
    r = p_elts[0];
    g = p_elts[1];
    b = p_elts[2];
    a = p_elts[3];
...
///////////////////////////////////////////////
template <class T> inline color4<T>::color4(const color4<T>& v) {
    r = v.r;
    g = v.g;
    b = v.b;
    a = v.a;
...
///////////////////////////////////////////////
template <class T> inline color4<T>::color4(T _x, T _y, T _z, T _w) {
    r = _x;
    g = _y;
    b = _z;
    a = _w;
...
///////////////////////////////////////////////
template <class T> inline void color4<T>::set(T _x, T _y, T _z, T _w) {
    r = _x;
    g = _y;
    b = _z;
    a = _w;
...
///////////////////////////////////////////////
template <class T> inline void color4<T>::set(T _x, T _y, T _z) {
    r = _x;
    g = _y;
    b = _z;
    a = 1;
...
///////////////////////////////////////////////
template <class T> inline color4<T> color4<T>::operator+() const {
    return *this;
}
...
///////////////////////////////////////////////
template <class T> inline color4<T>& color4<T>::operator+=(const color4<T>& v) {
    r += v.r;
    g += v.g;
    b += v.b;
    a += v.a;
...
///////////////////////////////////////////////
template <class T> inline color4<T>& color4<T>::operator*=(T s) {
    r *= s;
    g *= s;
    b *= s;
    a *= s;
...
///////////////////////////////////////////////
template <class T> inline color4<T> color4<T>::operator+(const color4<T>& v) const {
...
///////////////////////////////////////////////
template <class T> inline color4<T> color4<T>::operator*(T s) const {
...
///////////////////////////////////////////////
template <class T> inline bool color4<T>::operator==(const color4<T>& v) const {
...
///////////////////////////////////////////////
template <class T> inline color4<T> operator*(T s, const color4<T>& v) {
    return color4<T>(v.r * s, v.g * s, v.b * s, v.a * s);
}

///////////////////////////////////////////////
template <class T> inline unsigned char color4<T>::pack_rgb332() {
    unsigned char cr;
    unsigned char cg;
    unsigned char cb;
...
///////////////////////////////////////////////
template <class T> inline unsigned short color4<T>::pack_argb4444() {
    unsigned char cr;
    unsigned char cg;
    unsigned char cb;
    unsigned char ca;
...
///////////////////////////////////////////////
template <class T> inline unsigned short color4<T>::pack_rgb555() {
    unsigned char cr;
    unsigned char cg;
    unsigned char cb;
    if (sizeof(r) == 1) // char and unsigned char
...
///////////////////////////////////////////////
template <class T> inline unsigned short color4<T>::pack_rgb565() {
    unsigned char cr;
    unsigned char cg;
    unsigned char cb;
    if (sizeof(r) == 1) // char and unsigned char
...
///////////////////////////////////////////////
template <class T> inline unsigned int color4<T>::pack_rgb888() {
    unsigned char cr;
    unsigned char cg;
    unsigned char cb;
    if (sizeof(r) == 1) // char and unsigned char
...
///////////////////////////////////////////////
template <class T> inline unsigned int color4<T>::pack_argb8888() {
    unsigned char cr;
    unsigned char cg;
    unsigned char cb;
    unsigned char ca;
...
///////////////////////////////////////////////
template <class T> inline void color4<T>::clamp(T bottom, T top) {
    if (r < bottom)
        r = bottom;
    else if (r > top)
        r = top;
...
///////////////////////////////////////////////
template <class T> void color4<T>::maximum(const color4<T>& ca, const color4<T>& cb) {
...
///////////////////////////////////////////////
template <class T> void color4<T>::minimum(const color4<T>& ca, const color4<T>& cb) {
    r = (ca.r < cb.r) ? ca.r : cb.r;
    g = (ca.g < cb.g) ? ca.g : cb.g;
    b = (ca.b < cb.b) ? ca.b : cb.b;
    a = (ca.a < cb.a) ? ca.a : cb.a;
...
///////////////////////////////////////////////
template <class T> void color4<T>::abs() {
    r = (r < 0) ? -r : r;
    g = (g < 0) ? -g : g;
    b = (b < 0) ? -b : b;
    a = (a < 0) ? -a : a;
...
///////////////////////////////////////////////
template <class T> void color4<T>::adjust_contrast(T c) {
    r = 0.5f + c * (r - 0.5f);
    g = 0.5f + c * (g - 0.5f);
    b = 0.5f + c * (b - 0.5f);
    a = 0.5f + c * (a - 0.5f);
...
///////////////////////////////////////////////
template <class T> void color4<T>::adjust_saturation(T s) {
...
///////////////////////////////////////////////
template <class T> void color4<T>::lerp(const color4<T>& ca, const color4<T>& cb, T s) {
    r = ca.r + s * (cb.r - ca.r);
    g = ca.g + s * (cb.g - ca.g);
    b = ca.b + s * (cb.b - ca.b);
    a = ca.a + s * (cb.a - ca.a);
...
///////////////////////////////////////////////
template <class T> void color4<T>::negative(const color4<T>& c) {
    r = T(1.0f) - r;
    g = T(1.0f) - g;
    b = T(1.0f) - b;
    a = T(1.0f) - a;
...
///////////////////////////////////////////////
template <class T> void color4<T>::grey(const color4<T>& c) {
    T m = (r + g + b) / T(3);
