...
#if defined(LINUX)
#undef assert
#define assert(exp) ()((exp) || (printf("Assert: ' %s ' has failed\n", #exp), 0))
#endif
...
template <typename F> struct Matrix33diag_tpl {
    ...
    Matrix33diag_tpl(F dx, F dy, F dz) {
        x = dx;
        y = dy;
        z = dz;
    }

    Matrix33diag_tpl(const Vec3_tpl<F>& src) {
        x = src.x;
        y = src.y;
        z = src.z;
    }
    ...
    const Matrix33diag_tpl& identity() {
        x = y = z = 1;
        return *this;
    }

    const Matrix33diag_tpl& zero() {
        x = y = z = 0;
        return *this;
    }

    Matrix33diag_tpl& fabs() {
        x = fabs_tpl(x);
        y = fabs_tpl(y);
        z = fabs_tpl(z);
        return *this;
...
template <class F1, class F2> Matrix33diag_tpl<F1> operator*(const Matrix33diag_tpl<F1>& l, const Matrix33diag_tpl<F2>& r) {
    return Matrix33diag_tpl<F1>(l.x * r.x, l.y * r.y, l.z * r.z);
}

template <class F1, class F2, int SI, int SJ> Matrix33_tpl<F2, SI, SJ> operator*(const Matrix33diag_tpl<F1>& l, const Matrix33_tpl<F2, SI, SJ>& r) {
...
template <class F1, int SI, int SJ, class F2> Matrix33_tpl<F1, SI, SJ> operator*(const Matrix33_tpl<F1, SI, SJ>& l, const Matrix33diag_tpl<F2>& r) {
...
template <class F1, class F2> Matrix34_tpl<F1> operator*(const Matrix34_tpl<F1>& l, const Matrix33diag_tpl<F2>& r) {
    Matrix34_tpl<F1> m;
    m.m00 = l.m00 * r.x;
    m.m01 = l.m01 * r.y;
    m.m02 = l.m02 * r.z;
...
template <class F1, class F2> Matrix34_tpl<F2> operator*(const Matrix33diag_tpl<F1>& l, const Matrix34_tpl<F2>& r) {
    Matrix34_tpl<F2> m;
    m.m00 = l.x * r.m00;
    m.m01 = l.x * r.m01;
    m.m02 = l.x * r.m02;
...
template <class F1, int SI, int SJ, class F2> const Matrix33_tpl<F1, SI, SJ>& operator*=(const Matrix33_tpl<F1, SI, SJ>& l, const Matrix33diag_tpl<F2>& r) {
    l.M00 *= r.x;
    l.M01 *= r.y;
    l.M02 *= r.z;
    l.M10 *= r.x;
...
template <class F1, class F2> Vec3_tpl<F2> operator*(const Matrix33diag_tpl<F1>& mtx, const Vec3_tpl<F2>& vec) {
    return Vec3_tpl<F2>(mtx.x * vec.x, mtx.y * vec.y, mtx.z * vec.z);
}

template <class F1, class F2> Vec3_tpl<F1> operator*(const Vec3_tpl<F1>& vec, const Matrix33diag_tpl<F2>& mtx) {
...
template <class F, int SI, int SJ> struct Matrix33_tpl {
    ...
    template <class F1, int SI1, int SJ1> ILINE Matrix33_tpl(const Matrix33_tpl<F1, SI1, SJ1>& m) {
    ...
    template <class F1, int SI1, int SJ1> explicit ILINE Matrix33_tpl(const Matrix44_tpl<F1, SI1, SJ1>& m) {
        M00 = m_00;
        M01 = m_01;
        M02 = m_02;
        M10 = m_10;
    ...
    template <class F1, int SI1, int SJ1> ILINE Matrix33_tpl& operator=(const Matrix33_tpl<F1, SI1, SJ1>& m) {
        assert((SI == SI1) | ((void*)this != (void*)&m));
        M00 = m_00;
        M01 = m_01;
        M02 = m_02;
    ...
    template <class F1> Matrix33_tpl& operator=(const Matrix33diag_tpl<F1>& src) {
        M00 = src.x;
        M01 = 0;
        M02 = 0;
        M10 = 0;
    ...
    ILINE void SetRotationAA(F angle, Vec3_tpl<F> axis) {
        F cs[2];
        sincos_tpl(angle, cs);
        SetRotationAA(cs[0], cs[1], axis);
    }
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateRotationX(const f32 rad) {
        Matrix33_tpl<F, SI, SJ> m33;
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateRotationY(const f32 rad) {
        Matrix33_tpl<F, SI, SJ> m33;
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateRotationZ(const f32 rad) {
        Matrix33_tpl<F, SI, SJ> m33;
    ...
    ILINE void SetRotationXYZ(const Ang3_tpl<F>& rad) {
        F csx[2];
        sincos_tpl(rad.x, csx);
        F csy[2];
        sincos_tpl(rad.y, csy);
        F csz[2];
        sincos_tpl(rad.z, csz);
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateRotationXYZ(const Ang3_tpl<F>& rad) {
        Matrix33_tpl<F, SI, SJ> m33;
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateRotationV0V1(const Vec3_tpl<F>& v0, const Vec3_tpl<F>& v1) {
        Matrix33_tpl<F, SI, SJ> m33;
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateRotationV0(const Vec3_tpl<F>& n) {
        Matrix33_tpl<F, SI, SJ> m33;
        m33.SetRotationV0(n);
        return m33;
    }
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateScale(const Vec3_tpl<F>& s) {
        Matrix33_tpl<F, SI, SJ> m;
        m.SetScale(s);
        return m;
    }
    ...
    ILINE static Matrix33_tpl<F, SI, SJ> CreateMatFromVectors(const Vec3_tpl<F>& vx, const Vec3_tpl<F>& vy, const Vec3_tpl<F>& vz) {
        Matrix33_tpl<F, SI, SJ> dst;
        dst.SetMatFromVectors(vx, vy, vz);
        return dst;
    }
    ...
    ILINE Matrix33_tpl<F, SI, SJ> GetFabs() const {
    ...
    ILINE Matrix33_tpl<F, SI, SJ> GetAdjoint() const {
        Matrix33_tpl<F, SI, SJ> dst = *this;
        dst.Adjoint();
        return dst;
    }
    ...
    ILINE Matrix33_tpl<F, SI, SJ> GetInverted() const {
        Matrix33_tpl<F, SI, SJ> dst = *this;
        dst.Invert();
        return dst;
    }
    ...
    ILINE const Matrix33_tpl<F, SJ, SI>& T() const {
        return (const Matrix33_tpl<F, SJ, SI>&)*(&data[0]);
    }
    ILINE Matrix33_tpl<F, SJ, SI>& T() {
        return (Matrix33_tpl<F, SJ, SI>&)*(&data[0]);
    }

    ILINE F operator()(unsigned i, unsigned j) const {
        assert((i < 3) && (j < 3));
        return data[i * SI + j * SJ];
    }
    ...
    ILINE Vec3_tpl<F> GetRow(int iRow) const {
        return Vec3_tpl<F>(data[iRow * SI + 0 * SJ], data[iRow * SI + 1 * SJ], data[iRow * SI + 2 * SJ]);
    }
    ILINE void SetRow(int iRow, const Vec3_tpl<F>& row) {
        data[iRow * SI + 0 * SJ] = row.x;
        data[iRow * SI + 1 * SJ] = row.y;
        data[iRow * SI + 2 * SJ] = row.z;
    }

    ILINE Vec3_tpl<F> GetColumn(int iCol) const {
        return Vec3_tpl<F>(data[0 * SI + iCol * SJ], data[1 * SI + iCol * SJ], data[2 * SI + iCol * SJ]);
    }
    ILINE void SetColumn(int iCol, const Vec3_tpl<F>& col) {
        data[0 * SI + iCol * SJ] = col.x;
        data[1 * SI + iCol * SJ] = col.y;
        data[2 * SI + iCol * SJ] = col.z;
    }

    ILINE Vec3_tpl<F> GetOrtX() const {
        return Vec3_tpl<F>(M00, M10, M20);
    }
    ILINE Vec3_tpl<F> GetOrtY() const {
        return Vec3_tpl<F>(M01, M11, M21);
    }
    ILINE Vec3_tpl<F> GetOrtZ() const {
        return Vec3_tpl<F>(M02, M12, M22);
    }
    ...
    ILINE int IsIdentity() const {
        return 0 ==
               (fabs_tpl((F)1 - M00) + fabs_tpl(M01) + fabs_tpl(M02) + fabs_tpl(M10) + fabs_tpl((F)1 - M11) + fabs_tpl(M12) + fabs_tpl(M20) + fabs_tpl(M21) + fabs_tpl((F)1 - M22));
    }
    ...
    template <class F1> ILINE void extract_from4x4T(const Matrix44_tpl<F1, 4, 1>& m, Vec3_tpl<F>& offset, F& scale) {
        *this = Matrix33(m).T();
 ...
 *
 */
template <class F, int SI, int SJ> ILINE Matrix34_tpl<F> operator*(const Matrix33_tpl<F, SI, SJ>& l, const Matrix34_tpl<F>& r) {
    Matrix34_tpl<F> m;
...
template <class F1, int SI1, int SJ1, class F2, int SI2, int SJ2> ILINE Matrix33_tpl<F1, SI1, SJ1>& operator*=(Matrix33_tpl<F1, SI1, SJ1>& l, const Matrix33_tpl<F2, SI2, SJ2>& r) {
    F1 oldata[9];
    oldata[0] = l_00;
    oldata[1] = l_01;
    oldata[2] = l_02;
...
ILINE Matrix33_tpl<F1, SI1, SJ1> operator+(const Matrix33_tpl<F1, SI1, SJ1>& l, const Matrix33_tpl<F2, SI2, SJ2>& r) {
    ...
    res.data[SI1 * 0 + SJ1 * 0] = l_00 + r_00;
    res.data[SI1 * 0 + SJ1 * 1] = l_01 + r_01;
    res.data[SI1 * 0 + SJ1 * 2] = l_02 + r_02;
    res.data[SI1 * 1 + SJ1 * 0] = l_10 + r_10;
    res.data[SI1 * 1 + SJ1 * 1] = l_11 + r_11;
    res.data[SI1 * 1 + SJ1 * 2] = l_12 + r_12;
    res.data[SI1 * 2 + SJ1 * 0] = l_20 + r_20;
    res.data[SI1 * 2 + SJ1 * 1] = l_21 + r_21;
    res.data[SI1 * 2 + SJ1 * 2] = l_22 + r_22;
    return res;
}
template <class F1, int SI1, int SJ1, class F2, int SI2, int SJ2> ILINE Matrix33_tpl<F1, SI1, SJ1>& operator+=(Matrix33_tpl<F1, SI1, SJ1>& l, const Matrix33_tpl<F2, SI2, SJ2>& r) {
    l_00 += r_00;
...
template <class F, int SI, int SJ> ILINE Matrix33_tpl<F, SI, SJ> operator*(const Matrix33_tpl<F, SI, SJ>& m, F op) {
...
template <class F, int SI, int SJ> ILINE Matrix33_tpl<F, SI, SJ> operator/(const Matrix33_tpl<F, SI, SJ>& src, F op) {
    return src * ((F)1.0 / op);
}

// post-multiply
template <class F1, class F2, int SI, int SJ> ILINE Vec3_tpl<F1> operator*(const Matrix33_tpl<F2, SI, SJ>& m, const Vec3_tpl<F1>& v) {
    return Vec3_tpl<F1>(v.x * m.M00 + v.y * m.M01 + v.z * m.M02, v.x * m.M10 + v.y * m.M11 + v.z * m.M12, v.x * m.M20 + v.y * m.M21 + v.z * m.M22);
}

// pre-multiply
template <class F1, class F2, int SI, int SJ> ILINE Vec3_tpl<F1> operator*(const Vec3_tpl<F1>& v, const Matrix33_tpl<F2, SI, SJ>& m) {
    return Vec3_tpl<F1>(v.x * m.M00 + v.y * m.M10 + v.z * m.M20, v.x * m.M01 + v.y * m.M11 + v.z * m.M21, v.x * m.M02 + v.y * m.M12 + v.z * m.M22);
}

template <class F1, int SI, int SJ> ILINE Matrix33_tpl<F1, SI, SJ>& crossproduct_matrix(const Vec3_tpl<F1>& v, Matrix33_tpl<F1, SI, SJ>& m) {
    m.M00 = 0;
    m.M01 = -v.z;
    m.M02 = v.y;
    m.M10 = v.z;
...
template <class F1, int SI, int SJ> ILINE Matrix33_tpl<F1, SI, SJ>& dotproduct_matrix(const Vec3_tpl<F1>& v, const Vec3_tpl<F1>& op, Matrix33_tpl<F1, SI, SJ>& m) {
    m.M00 = v.x * op.x;
    m.M10 = v.y * op.x;
    m.M20 = v.z * op.x;
    m.M01 = v.x * op.y;
...
template <typename F> struct Matrix34_tpl {
    ...
    explicit ILINE Matrix34_tpl(const Quaternion_tpl<F>& q) {
        *this = Matrix33(q);
    }

    template <int SI, int SJ> ILINE Matrix34_tpl(const Matrix33_tpl<F, SI, SJ>& m) {
        m00 = m.M00;
        m01 = m.M01;
        m02 = m.M02;
        m03 = 0;
    ...
    template <int SI, int SJ> ILINE explicit Matrix34_tpl(const Matrix44_tpl<F, SI, SJ>& m) {
        m00 = m.M00;
        m01 = m.M01;
        m02 = m.M02;
        m03 = m.M03;
    ...
    void SetIdentity();
    static Matrix34_tpl<F> CreateIdentity();
    ...
    ILINE static Matrix34_tpl<F> CreateMatFromVectors(const Vec3_tpl<F>& vx, const Vec3_tpl<F>& vy, const Vec3_tpl<F>& vz, const Vec3_tpl<F>& pos) {
        Matrix34_tpl<F> m;
        m.SetMatFromVectors34(vx, vy, vz, pos);
        return m;
    }
 ...
 *
 */
template <class F> ILINE Vec3_tpl<F> operator*(const Matrix34_tpl<F>& m, const Vec3_tpl<F>& p) {
    Vec3_tpl<F> tp;
...
template <class F, int SI, int SJ> ILINE Matrix34_tpl<F> operator*(const Matrix34_tpl<F>& l, const Matrix33_tpl<F, SI, SJ>& r) {
    Matrix34_tpl<F> m;
    m.m00 = l.m00 * r.M00 + l.m01 * r.M10 + l.m02 * r.M20;
    m.m10 = l.m10 * r.M00 + l.m11 * r.M10 + l.m12 * r.M20;
    m.m20 = l.m20 * r.M00 + l.m21 * r.M10 + l.m22 * r.M20;
 ...
 *
 */
template <class F> ILINE Matrix34_tpl<F> operator*(const Matrix34_tpl<F>& l, const Matrix34_tpl<F>& r) {
    Matrix34_tpl<F> m;
    m.m00 = l.m00 * r.m00 + l.m01 * r.m10 + l.m02 * r.m20;
    m.m10 = l.m10 * r.m00 + l.m11 * r.m10 + l.m12 * r.m20;
    m.m20 = l.m20 * r.m00 + l.m21 * r.m10 + l.m22 * r.m20;
...
template <class F, int SI, int SJ> ILINE Matrix44_tpl<F, SI, SJ> operator*(const Matrix34_tpl<F>& l, const Matrix44_tpl<F, SI, SJ>& r) {
 ...
 *
 */
template <class F> ILINE void Matrix34_tpl<F>::SetIdentity() {
    m00 = 1.0f;
    m01 = 0.0f;
    m02 = 0.0f;
    m03 = 0.0f;
...
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateIdentity() {
    Matrix34_tpl<F> m34;
    m34.SetIdentity();
    return m34;
}
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::SetTranslation(const Vec3_tpl<F>& t) {
    m03 = t.x;
    m13 = t.y;
    m23 = t.z;
}
 ...
 *
 */
template <class F> ILINE Vec3_tpl<F> Matrix34_tpl<F>::GetTranslation() const {
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::SetRotationAA(const F rad, const Vec3_tpl<F>& axis, const Vec3_tpl<F>& t) {
    assert((fabs_tpl(1 - (axis | axis))) < 0.001); // check if unit-vector
    *this = Matrix33::CreateRotationAA(rad, axis);
    this->SetTranslation(t);
}
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationAA(const F rad, const Vec3_tpl<F>& axis, const Vec3_tpl<F>& t) {
    Matrix34_tpl<F> m34;
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::SetRotationX(const f32 rad, const Vec3_tpl<F>& t) {
    *this = Matrix33::CreateRotationX(rad);
    this->SetTranslation(t);
}
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationX(const f32 rad, const Vec3_tpl<F>& t) {
    Matrix34_tpl<F> m34;
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::SetRotationY(const f32 rad, const Vec3_tpl<F>& t) {
    *this = Matrix33::CreateRotationY(rad);
    this->SetTranslation(t);
}
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationY(const f32 rad, const Vec3_tpl<F>& t) {
    Matrix34_tpl<F> m34;
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::SetRotationZ(const f32 rad, const Vec3_tpl<F>& t) {
    *this = Matrix33::CreateRotationZ(rad);
    this->SetTranslation(t);
}
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationZ(const f32 rad, const Vec3_tpl<F>& t) {
    Matrix34_tpl<F> m34;
    m34.SetRotationZ34(rad, t);
    return m34;
}
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::SetRotationXYZ(const Ang3_tpl<F>& rad, const Vec3_tpl<F>& t) {
    *this = Matrix33::CreateRotationXYZ(rad);
    this->SetTranslation(t);
}
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationXYZ(const Ang3_tpl<F>& rad, const Vec3_tpl<F>& t) {
    Matrix34_tpl<F> m34;
...
*/
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateScale(const Vec3_tpl<F>& s, const Vec3_tpl<F>& t) {
    Matrix34_tpl<F> m34;
    m34.SetScale(s, t);
    return m34;
}
 ...
 */
template <class F> ILINE void Matrix34_tpl<F>::Invert() {
    // rescue members
...
template <class F> ILINE Matrix34_tpl<F> Matrix34_tpl<F>::GetInverted() {
...
template <class F, int SI, int SJ> struct Matrix44_tpl {
    ...
    template <class F1, int SI1, int SJ1> ILINE Matrix44_tpl(const Matrix33_tpl<F1, SI1, SJ1>& m) {
        M00 = m_00;
        M01 = m_01;
        M02 = m_02;
        M03 = 0;
    ...
    template <int SI1, int SJ1> ILINE Matrix44_tpl(const Matrix44_tpl<F, SI1, SJ1>& m) {
        assert((SI == SI1) | ((void*)this != (void*)&m));
        M00 = m.M00;
        M01 = m.M01;
        M02 = m.M02;
    ...
    explicit ILINE Matrix44_tpl(const Quaternion_tpl<F>& q) {
        *this = Matrix33(q);
    }

    // non-templated version is needed since default operator= has precedence over templated operator=
    template <class F1, int SI1, int SJ1> Matrix44_tpl& operator=(const Matrix33_tpl<F1, SI1, SJ1>& m) {
        M00 = m_00;
        M01 = m_01;
        M02 = m_02;
        M03 = 0;
    ...
    template <class F1, int SI1, int SJ1> ILINE Matrix44_tpl& operator=(const Matrix44_tpl<F1, SI1, SJ1>& m) {
        assert((SI == SI1) | ((void*)this != (void*)&m));
        M00 = m_00;
        M01 = m_01;
        M02 = m_02;
    ...
    ILINE Matrix44_tpl(f32 v00, f32 v01, f32 v02, f32 v03, f32 v10, f32 v11, f32 v12, f32 v13, f32 v20, f32 v21, f32 v22, f32 v23, f32 v30, f32 v31, f32 v32, f32 v33) {
        M00 = v00;
        M01 = v01;
        M02 = v02;
        M03 = v03;
    ...
    ILINE Matrix44_tpl<F, SI, SJ>& operator*=(const Matrix44_tpl<F, SI, SJ>& m) {
        operator=(*this* m);
        return *this;
    }
    ...
    Vec3_tpl<F> GetColumn(int iCol) const {
        return Vec3_tpl<F>(data[0 * SI + iCol * SJ], data[1 * SI + iCol * SJ], data[2 * SI + iCol * SJ]);
    }
    void SetColumn(int iCol, const Vec3_tpl<F>& col) {
        data[0 * SI + iCol * SJ] = col.x;
        data[1 * SI + iCol * SJ] = col.y;
        data[2 * SI + iCol * SJ] = col.z;
    }
    ...
    ILINE F* operator[](int index) {
        return &data[index * SI];
    }
    ILINE const F* operator[](int index) const {
        return &data[index * SI];
    }
    ...
    /*  ILINE static Matrix44_tpl<F,SI,SJ> CreateRotationXYZ44( const Ang3_tpl<F>& rad, const Vec3_tpl<F>& t=Vec3(0.0f,0.0f,0.0f) )  {
            ...
            ILINE friend Matrix44_tpl<F,4,1> CreateRotationXYZ44( const Ang3_tpl<F>& rad, const Vec3_tpl<F>& t )  {  Matrix44_tpl<F,4,1> m; m.SetRotationXYZ44(rad,t); return
       m; } ILINE friend Matrix44_tpl<F,4,1> CreateRotationXYZ44( const Ang3_tpl<F>& rad )  {  Matrix44_tpl<F,4,1> m; m.SetRotationXYZ44(rad); return m;  }
*/
    ...
    ILINE static Matrix44_tpl<F, SI, SJ> GetInverted44(const Matrix44_tpl<F, SI, SJ>& m) {
        Matrix44_tpl<F, SI, SJ> dst = m;
        dst.Invert44();
        return dst;
    }
    ILINE friend Matrix44_tpl<F, 4, 1> GetInverted44(const Matrix44_tpl<F, 4, 1>& m) {
        return Matrix44::GetInverted44(m);
    }
    ...
    ILINE Vec3 GetTranslationOLD() const {
        return Vec3(M30, M31, M32);
    }
    ILINE void SetTranslationOLD(const Vec3& t) {
        M30 = t.x;
        M31 = t.y;
        M32 = t.z;
    }
    ILINE void AddTranslationOLD(const Vec3& t) {
        M30 += t.x;
        M31 += t.y;
        M32 += t.z;
    }
    ILINE void ScaleTranslationOLD(f32 s) {
        M30 *= s;
        M31 *= s;
        M32 *= s;
    }
 ...
 *
 */
template <class F, int SI, int SJ> ILINE Matrix44_tpl<F, SI, SJ> operator*(const Matrix44_tpl<F, SI, SJ>& l, const Matrix34_tpl<F>& r) {
    Matrix44_tpl<F, SI, SJ> m;
    m.M00 = l.M00 * r.m00 + l.M01 * r.m10 + l.M02 * r.m20;
    m.M10 = l.M10 * r.m00 + l.M11 * r.m10 + l.M12 * r.m20;
    m.M20 = l.M20 * r.m00 + l.M21 * r.m10 + l.M22 * r.m20;
...
ILINE Vec3 UntransformVector(const Matrix44& m, const Vec3& v) {
    return Vec3(m(0, 0) * v.x + m(0, 1) * v.y + m(0, 2) * v.z, m(1, 0) * v.x + m(1, 1) * v.y + m(1, 2) * v.z, m(2, 0) * v.x + m(2, 1) * v.y + m(2, 2) * v.z);
}
