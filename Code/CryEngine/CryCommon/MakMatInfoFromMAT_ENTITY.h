...
inline bool CIndexedMesh__LoadMaterial(const char* szFileName, const char* szFolderName, CMatInfo& newMat, IRenderer* pRenderer, MAT_ENTITY* me) {
    ...
    if (!pRenderer) { // in compiler remember also source MAT_ENTITY
