...
#define BEGIN_INPUTACTIONMAP()                                                                                                                                                     \
    void OnAction(XACTIONID nActionID, float fValue, XActivationEvent ae) {                                                                                                        \
        switch (nActionID) {
#define END_INPUTACTIONMAP()                                                                                                                                                       \
    default:                                                                                                                                                                       \
        break;                                                                                                                                                                     \
        }                                                                                                                                                                          \
        }
#define REGISTER_INPUTACTIONMAP(actionid, handler)                                                                                                                                 \
    case actionid:                                                                                                                                                                 \
        handler(fValue, ae);                                                                                                                                                       \
        break;
...
enum XActionActivationMode { aamOnPress, aamOnDoublePress, aamOnPressAndRelease, aamOnRelease, aamOnHold };

enum XActivationEvent { etPressing, etHolding, etReleasing, etDoublePressing };
...
#define BEGIN_INPUTACTIONTRIGGERS()                                                                                                                                                \
    void OnAction(INPUTACTIONID nActionID, float fValue) {                                                                                                                         \
        switch (nActionID) {
#define END_INPUTACTIONTRIGGERS()                                                                                                                                                  \
    default:                                                                                                                                                                       \
        break;                                                                                                                                                                     \
        }                                                                                                                                                                          \
        }
#define REGISTER_INPUTACTIONTRIGGER(actionid, handler)                                                                                                                             \
    case actionid:                                                                                                                                                                 \
        handler(fValue);                                                                                                                                                           \
        break;
//@}
