...
struct CryCharAnimationParams {
    CryCharAnimationParams(float _fBlendInTime = 0.125f, float _fBlendOutTime = 0.125f, int _nLayerID = 0, unsigned _nFlags = 0)
        : fBlendInTime(_fBlendInTime), fBlendOutTime(_fBlendOutTime), nLayerID(_nLayerID), nFlags(_nFlags) {}
