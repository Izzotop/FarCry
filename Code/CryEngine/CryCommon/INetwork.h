...
enum CryNetworkVarible { cnvDataStreamTimeout = 0 };
...
struct IServerSlotSink {
    ...
    */
    ...
    //!
    virtual void OnXPlayerAuthorization(bool bAllow, const char* szError, const BYTE* pGlobalID, unsigned int uiGlobalIDSize) = 0;
};
...
struct IServerSlot {
    ...
    */
    ...
    virtual void OnPlayerAuthorization(bool bAllow, const char* szError, const BYTE* pGlobalID, unsigned int uiGlobalIDSize) = 0;
};
