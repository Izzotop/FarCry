...
ILINE void cry_sincosf(float angle, float* pCosSin) {
    fastsincosf(angle, pCosSin);
}
ILINE void cry_sincos(double angle, double* pCosSin) {
    pCosSin[0] = cos(angle);
    pCosSin[1] = sin(angle);
}
ILINE float cry_sinf(float x) {
    return fastsinf(x);
}
ILINE float cry_cosf(float x) {
    return fastcosf(x);
}

ILINE float cry_fmod(float x, float y) {
    return (float)fmod((double)x, (double)y);
}

ILINE float cry_asinf(float x) {
    return (float)asin((double)x);
}
ILINE float cry_acosf(float x) {
    return (float)acos((double)x);
}
ILINE float cry_atanf(float x) {
    return (float)atan((double)x);
}
ILINE float cry_atan2f(float x, float y) {
    return (float)atan2((double)x, (double)y);
}

ILINE float cry_tanhf(float x) {
    double expz = exp(double(x)), exp_z = exp(-double(x));
    return (float)((expz - exp_z) / (expz + exp_z));
}
ILINE float cry_tanf(float x) {
    return (float)tan((double)x);
}

ILINE float cry_sqrtf(float x) {
    return (float)sqrt((double)x);
}
ILINE float cry_fabsf(float x) {
    return (float)fabs((double)x);
}
ILINE float cry_expf(float x) {
    return (float)exp((double)x);
}
ILINE float cry_logf(float x) {
    return (float)log((double)x);
}
ILINE float cry_powf(float x, float y) {
    return (float)pow((double)x, (double)y);
}

ILINE float cry_ceilf(float x) {
    return (float)ceil((double)x);
}
ILINE float cry_floorf(float x) {
    return (float)floor((double)x);
}

ILINE double cry_sinh(double z) {
    return (exp(z) - exp(-z)) * 0.5;
}
ILINE double cry_cosh(double z) {
    return (exp(z) + exp(-z)) * 0.5;
}
#endif
...
ILINE void cry_sincosf(float angle, float* pCosSin) {
    pCosSin[0] = (float)cos(angle);
    pCosSin[1] = (float)sin(angle);
}
ILINE void cry_sincos(double angle, double* pCosSin) {
    pCosSin[0] = cos(angle);
    pCosSin[1] = sin(angle);
...
ILINE void sincos_tpl(double angle, double* pCosSin) {
    cry_sincos(angle, pCosSin);
}
ILINE void sincos_tpl(float angle, float* pCosSin) {
    cry_sincosf(angle, pCosSin);
}

ILINE double cos_tpl(double op) {
    return cos(op);
}
ILINE float cos_tpl(float op) {
    return cry_cosf(op);
}

ILINE double sin_tpl(double op) {
    return sin(op);
}
ILINE float sin_tpl(float op) {
    return cry_sinf(op);
}

ILINE double acos_tpl(double op) {
    return acos(op);
}
ILINE float acos_tpl(float op) {
    return cry_acosf(op);
}

ILINE double asin_tpl(double op) {
    return asin(op);
}
ILINE float asin_tpl(float op) {
    return cry_asinf(op);
}

ILINE double atan_tpl(double op) {
    return atan(op);
}
ILINE float atan_tpl(float op) {
    return cry_atanf(op);
}

ILINE double atan2_tpl(double op1, double op2) {
    return atan2(op1, op2);
}
ILINE float atan2_tpl(float op1, float op2) {
    return cry_atan2f(op1, op2);
}

ILINE double exp_tpl(double op) {
    return exp(op);
}
ILINE float exp_tpl(float op) {
    return cry_expf(op);
}

ILINE double log_tpl(double op) {
    return log(op);
}
ILINE float log_tpl(float op) {
    return cry_logf(op);
}

ILINE double sqrt_tpl(double op) {
    return sqrt(op);
}
ILINE float sqrt_tpl(float op) {
    return cry_sqrtf(op);
}

ILINE double fabs_tpl(double op) {
    return fabs(op);
}
ILINE float fabs_tpl(float op) {
    return cry_fabsf(op);
}
ILINE int fabs_tpl(int op) {
    int mask = op >> 31;
    return op + mask ^ mask;
}

ILINE int floor_tpl(int op) {
    return op;
}
ILINE float floor_tpl(float op) {
    return cry_floorf(op);
}
ILINE double floor_tpl(double op) {
    return floor(op);
}

ILINE int ceil_tpl(int op) {
    return op;
}
ILINE float ceil_tpl(float op) {
    return cry_ceilf(op);
}
ILINE double ceil_tpl(double op) {
    return ceil(op);
}

ILINE float tan_tpl(float op) {
    return cry_tanf(op);
}
ILINE double tan_tpl(double op) {
    return tan(op);
}
...
#else
inline int incm3(int i) {
    return i + 1 & (i - 2) >> 31;
}
inline int decm3(int i) {
    return i - 1 + ((i - 1) >> 31 & 3);
}
#endif
...
template <class F> inline F square(F fOp) {
    return (fOp * fOp);
}

// this can easily be confused with square-root?
template <class F> inline F sqr(const F& op) {
    return op * op;
}

template <class F> inline F cube(const F& op) {
    return op * op * op;
}
template <class F> inline F sqr_signed(const F& op) {
    return op * fabs_tpl(op);
}
...
inline float sqr(vectorf op) {
    return op * op;
}
inline real sqr(vectorr op) {
    return op * op;
}
...
inline int getexp(float x) {
    return (int)(*(unsigned int*)&x >> 23 & 0x0FF) - 127;
}
inline int getexp(double x) {
    return (int)(*((unsigned int*)&x + 1) >> 20 & 0x7FF) - 1023;
}

inline float& setexp(float& x, int iexp) {
    (*(unsigned int*)& x &= ~(0x0FF << 23)) |= (iexp + 127) << 23;
    return x;
}
inline double& setexp(double& x, int iexp) {
    (*((unsigned int*)&x + 1) &= ~(0x7FF << 20)) |= (iexp + 1023) << 20;
    return x;
}
...
public:
    ...
    template <class F> unused_marker& operator,(Vec3_tpl<F>& x) {
        return *this, x.x;
    }
    template <class F> unused_marker& operator,(Quaternion_tpl<F>& x) {
        return *this, x.w;
    }
};
inline bool is_unused(const float& x) {
    return (*(int*)&x & 0xFFA00000) == 0xFFA00000;
}
inline bool is_unused(int x) {
    return x == 1 << 31;
}
inline bool is_unused(unsigned int x) {
    return x == 1u << 31;
}
template <class ref> bool is_unused(ref* x) {
    return x == (ref*)-1;
}
template <class F> bool is_unused(const Vec3_tpl<F>& x) {
    return is_unused(x.x);
}
template <class F> bool is_unused(const Quaternion_tpl<F>& x) {
    return is_unused(x.w);
}
inline bool is_unused(const double& x) {
    return (*((int*)&x + 1) & 0xFFF40000) == 0xFFF40000;
}
...
public:
    ...
    strided_pointer(dtype* pdata, int stride = sizeof(dtype)) {
        data = pdata;
        iStride = stride;
    }
    strided_pointer(const strided_pointer& src) {
        data = src.data;
        iStride = src.iStride;
    }
    template <class dtype1> strided_pointer(const strided_pointer<dtype1>& src) {
        data = src.data;
        iStride = src.iStride;
    }
    ...
    strided_pointer& operator=(const strided_pointer<dtype>& src) {
        data = src.data;
        iStride = src.iStride;
        return *this;
    }
    template <class dtype1> strided_pointer& operator=(const strided_pointer<dtype1>& src) {
        data = src.data;
        iStride = src.iStride;
        return *this;
    }
    ...
    dtype& operator[](int idx) {
        return *(dtype*)((char*)data + idx * iStride);
    }
    const dtype& operator[](int idx) const {
        return *(const dtype*)((const char*)data + idx * iStride);
    }
    strided_pointer<dtype> operator+(int idx) const {
        return strided_pointer<dtype>((dtype*)((char*)data + idx * iStride), iStride);
    }
    strided_pointer<dtype> operator-(int idx) const {
        return strided_pointer<dtype>((dtype*)((char*)data - idx * iStride), iStride);
    }
...
template <class F>
int unite_lists(F* pSrc0, INT_PTR nSrc0, F* pSrc1, INT_PTR nSrc1, F* pDst, int szdst) // AMD Port
{
    int i0, i1, n;
...
template <class F> inline F max_safe(F op1, F op2) {
    return op1 > op2 ? op1 : op2;
} // int mask=isneg(op2-op1); return op1*mask+op2*(mask^1); }
template <class F> inline F min_safe(F op1, F op2) {
    return op1 < op2 ? op1 : op2;
} //{ int mask=isneg(op1-op2); return op1*mask+op2*(mask^1); }
