...
*/
#define HAS_TM_GETGLOBAL(L, t) (1 << (t) & ((1 << LUA_TUSERDATA) | (1 << LUA_TTABLE) | (1 << LUA_TNIL)))

#define HAS_TM_SETGLOBAL(L, t) (1 << (t) & ((1 << LUA_TUSERDATA) | (1 << LUA_TTABLE) | (1 << LUA_TNIL) | (1 << LUA_TFUNCTION)))
