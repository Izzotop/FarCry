...
public:
    ...
    //!
    IScriptSystemSink* GetSystemSink() {
        return m_pSink;
    };
    //!
    ...
    virtual void SetGlobalTonullptr(const char* sKey);
