...
struct SScriptState {
    ...
    SScriptState(const SScriptState& s) {
        *this = s;
    }
...
//////////////////////////////////////////////////////////////////////
class CEntity : public IEntity, public IEntityCharacter {
public:
    ...
    virtual bool IsStatic() const {
        return false;
    } // Entities are dynamic by definition

    virtual EntityClassId GetClassId() {
        return m_ClassId;
    }
    virtual void SetClassId(const EntityClassId ClassId) {
        m_ClassId = ClassId;
    }
    ...
    bool GetNetPresence() const {
        return m_netPresence;
    };

    void SetNetPresence(bool ispresent) {
        m_netPresence = ispresent;
    }
    ...
    void SetWaterDensity(float fWaterDensity) {
        m_fWaterDensity = fWaterDensity;
    }
    float GetWaterDensity() {
        return (m_fWaterDensity);
    }
    ...
    //! Set new camera.
    void SetCamera(IEntityCamera* pCam) {
    ...
    bool HavePhysics() const {
        return m_physic != 0 || m_physPlaceholder != 0;
    };
    //! Get physics entity.
    ...
    bool CreateParticleEntity(float size, float mass, Vec3d heading, float acc_thrust = 0, float k_air_resistance = 0, float acc_lift = 0, float gravity = -9.8,
                              int surface_idx = 0, bool bSingleContact = true);
    ...
    void SetRadius(float r) {
        m_fRadius = r;
        SetBBox(Vec3d(-r, -r, -r), Vec3d(r, r, r));
    }
    ...
    virtual void SetUpdateRadius(float fUpdateRadius) {
        m_fUpdateRadius = fUpdateRadius;
    };
    virtual float GetUpdateRadius() const {
        return m_fUpdateRadius;
    };
    ...
    */
    ...
    bool IsMoving() const {
        return (!IsEquivalent(m_center, m_vPrevDrawCenter, 0.0025f)) || (!IsEquivalent(m_angles, m_vPrevDrawAngles, 0.0025f)) || (m_fScale != m_fPrevDrawScale);
    };
    ...
    virtual IEntityCharacter* GetCharInterface() const {
        return (IEntityCharacter*)this;
    }
    ...
    void SetScriptUpdateRate(float fUpdateEveryNSeconds) {
        m_fScriptUpdateRate = fUpdateEveryNSeconds;
    };
    ...
    virtual bool IsStateClientside() const {
        return m_bStateClientside;
    }
    virtual void SetStateClientside(const bool bEnable) {
        m_bStateClientside = bEnable;
    }
    ...
    void SetHasEnvLighting(const bool bEnable) {
        m_bHasEnvLighting = bEnable;
    }
    ...
    */
    ...
    virtual int CreateEntityParticleEmitter(int nSlotId, const ParticleParams& PartParams, float fSpawnPeriod, Vec3d vOffSet, Vec3d vDir, IParticleEffect* pEffect = 0,
                                            float fScale = 1.0f);
...
protected:
    ...
    template <class T1> void CallStateFunction(EScriptStateFunctions function, T1 param1);
    template <class T1, class T2> void CallStateFunction(EScriptStateFunctions function, T1 param1, T2 param2);
    template <class T1, class T2, class T3> void CallStateFunction(EScriptStateFunctions function, T1 param1, T2 param2, T3 param3);
    //////////////////////////////////////////////////////////////////////////
...
template <class T1> inline void CEntity::CallStateFunction(EScriptStateFunctions function, T1 param1) {
...
//////////////////////////////////////////////////////////////////////////
template <class T1, class T2> inline void CEntity::CallStateFunction(EScriptStateFunctions function, T1 param1, T2 param2) {
    HSCRIPTFUNCTION funcServer = 0;
    HSCRIPTFUNCTION funcClient = 0;
    if (m_pServerState)
        funcServer = m_pServerState->pFunction[function];
...
//////////////////////////////////////////////////////////////////////////
template <class T1, class T2, class T3> inline void CEntity::CallStateFunction(EScriptStateFunctions function, T1 param1, T2 param2, T3 param3) {
    HSCRIPTFUNCTION funcServer = 0;
    HSCRIPTFUNCTION funcClient = 0;
    if (m_pServerState)
        funcServer = m_pServerState->pFunction[function];
