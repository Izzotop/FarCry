...
////////////////////////////////////////////////////
    ...
    inline float GetDeltaX() {
        return m_Deltas[0] * (m_fSensitivity * m_fSensitivityScale);
    }
    inline float GetDeltaY() {
        return m_Deltas[1] * (m_fSensitivity * m_fSensitivityScale);
    }
    ...
    inline void SetInertia(float kinertia) {
        m_kInertia = kinertia;
    }
