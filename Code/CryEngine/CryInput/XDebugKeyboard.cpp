...
bool CXDebugKeyboard::Init(CInput* pInput, ILog* pLog) {
    ...
    */
    ...
    DWORD dwReturn;
    XINPUT_DEBUG_KEYQUEUE_PARAMETERS xdkp = {XINPUT_DEBUG_KEYQUEUE_FLAG_KEYDOWN | XINPUT_DEBUG_KEYQUEUE_FLAG_KEYUP, 25, 500, 50};
    ...
    for (DWORD i = 0; i < XGetPortCount(); i++) {
        if (dwDeviceMask & (1 << i)) {
            ...
            m_hDebugKeyboard = XInputOpen(XDEVICE_TYPE_DEBUG_KEYBOARD, i, XDEVICE_NO_SLOT, &pollValues);
