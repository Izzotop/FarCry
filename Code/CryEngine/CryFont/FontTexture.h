...
public:
    ...
    int CreateFromFile(const string& szFileName, int iWidth, int iHeight, int iSmoothMethod, int iSmoothAmount, float fSizeRatio = 0.8f, int iWidthCharCount = 16,
                       int iHeightCharCount = 16);
    int CreateFromMemory(unsigned char* pFileData, int iDataSize, int iWidth, int iHeight, int iSmoothMethod, int iSmoothAmount, float fSizeRatio = 0.875f,
                         int iWidthCharCount = 16, int iHeightCharCount = 16);
    ...
    int SetEncoding(FT_Encoding pEncoding) {
        return m_pGlyphCache.SetEncoding(pEncoding);
    };
    FT_Encoding GetEncoding() {
        return m_pGlyphCache.GetEncoding();
    };
    ...
    int GetWidthCellCount() {
        return m_iWidthCellCount;
    };
    int GetHeightCellCount() {
        return m_iHeightCellCount;
    };

    float GetTextureCellWidth() {
        return m_fTextureCellWidth;
    };
    float GetTextureCellHeight() {
        return m_fTextureCellHeight;
    };
