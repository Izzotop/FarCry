...
CFBitmap::CFBitmap() : m_iWidth(0), m_iHeight(0), m_pData(nullptr), m_pIRenderData(nullptr) {}
...
#define W16(val)                                                                                                                                                                   \
    {                                                                                                                                                                              \
        unsigned short t16 = (val);                                                                                                                                                \
        fwrite(&t16, 2, 1, hFile);                                                                                                                                                 \
    }
#define W32(val)                                                                                                                                                                   \
    {                                                                                                                                                                              \
        unsigned int t32 = (val);                                                                                                                                                  \
        fwrite(&t32, 4, 1, hFile);                                                                                                                                                 \
    }
