...
void CFFont::SetColor(const color4f& col, int nPass) {
    ...
    if (nPass < 0) {
        for (std::vector<SRenderingPass>::iterator i = m_pCurrentEffect->vPass.begin(); i != m_pCurrentEffect->vPass.end(); ++i) {
            pPass = &(*i);
            pPass->SetColor(col);
        }
    } else {
...
// #define FONT_RGBA(r, g, b, a) ((((long)((a)*255)) << 24) | (((long)((r)*255)) << 16) | (((long)((g)*255)) << 8) | (long)((b)*255))

#define FONT_RGBA(r, g, b, a) ((((long)((a)*255)) << 24) | (((long)((b)*255)) << 16) | (((long)((g)*255)) << 8) | (long)((r)*255))
