...
public:
    ...
    unsigned int GetCurrentSamplePos() {
        return 0;
    }
    ...
    unsigned int GetCurrentSamplePos(bool bMilliSeconds = false) {
        return (0);
    }
...
public:
    ...
    IMusicSystem* CreateMusicSystem() {
        return new CDummyMusicSystem(nullptr);
    }
    ...
    bool PlayMusic(const char* szFileName) {
        return false;
    }
    void StopMusic() {}
    void Silence() {}
