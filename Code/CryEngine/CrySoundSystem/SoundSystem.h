...
enum ESoundActiveState { eSoundState_None, eSoundState_Active, eSoundState_Inactive };
...
public:
    ...
    CS_DSPUNIT* GetDSPUnitFilter() {
        return m_pDSPUnitSFXFilter;
    }
    ...
    */
    ...
    int GetMinSoundPriority() {
        return m_nMinSoundPriority;
    };
    ...
    */
    ...
    bool SetEaxListenerEnvironment(int nPreset, CS_REVERB_PROPERTIES* pProps = nullptr, int nFlags = 0);
    ...
    float GetDirectionalAttenuationMaxScale() {
        return m_fDirAttMaxScale;
    }

    //! returns if directional attenuation is used
    bool UsingDirectionalAttenuation() {
        return (m_fDirAttCone != 0.0f);
    }
    ...
    IVisArea* GetListenerArea() {
        return (m_pVisArea);
    }
    Vec3d GetListenerPos() {
        return (m_cCam.GetPos());
    }

    void BufferLoaded(CSoundBuffer* pSoundBuffer) {
        m_nBuffersLoaded++;
    }
    void BufferUnloaded(CSoundBuffer* pSoundBuffer) {
        m_nBuffersLoaded--;
    }
