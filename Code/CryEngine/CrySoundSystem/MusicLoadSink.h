...
public:
    CMusicLoadSink(SMusicData* pMusicData, IScriptSystem* pScriptSystem, _SmartScriptObject* pObj, int nMode = MUSICLOAD_MODE_BASE, SPatternDef* pPattern = nullptr,
        ...
        case svtObject: {
            ...
            case MUSICLOAD_MODE_PATTERNSET: {
                ...
                if (pObj->GetValue("IncidentalLayer", pSubObj)) {
                    ...
                    _SmartScriptObject pPatternsSubObj(m_pScriptSystem, true);
                    if (pSubObj->GetValue("Patterns", pPatternsSubObj)) {
                        CMusicLoadSink Sink(m_pMusicData, m_pScriptSystem, &pPatternsSubObj, MUSICLOAD_MODE_MOODLAYERS, nullptr, m_pTheme, m_pMood, pPatternSet,
