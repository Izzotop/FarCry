...
bool InitDedicatedServer_System(const char* sInCmdLine) {
    ...
    PFNCREATESYSTEMINTERFACE pfnCreateSystemInterface = (PFNCREATESYSTEMINTERFACE)CryGetProcAddress(g_hSystemHandle, "CreateSystemInterface");
    ...
    g_psvDedicatedMaxRate = pConsole->CreateVariable(
        "sv_DedicatedMaxRate", "80", 0,
    ...
    {
        ICVar* pLightmapVar = pConsole->GetCVar("e_light_maps");
        assert(pLightmapVar);
