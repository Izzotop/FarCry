...
#define DQUOTECHAR _T('\"')
    ...
    if (*lpszCommandLine == DQUOTECHAR) {
        ...
        // another double-quote or a nullptr is encountered.
        do {
    ...
    return _tWinMain(::GetModuleHandle(nullptr), nullptr, lpszCommandLine, (StartupInfo.dwFlags & STARTF_USESHOWWINDOW) ? StartupInfo.wShowWindow : SW_SHOWDEFAULT);
}
// #endif
