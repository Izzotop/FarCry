...
bool CDataProbe::GetDataCode(char* pBuf, int nSize, SDataProbeContext& ctx) {
    ...
    case DATAPROBE_ADLER32: {
        unsigned int code = ADLER_32(0L, nullptr, 0);
...
bool CDataProbe::CheckLoader(void* pFunc) {
    ...
    int keys[6][4] = {
        {1873613783, 235688123, 812763783, 1745863682}, {1897178562, 734896899, 156436554, 902793442}, {1178362782, 223786232, 371615531, 90884141},
        {89158165, 1389745433, 971685123, 785741042},   {389623487, 373673863, 657846392, 378467832},  {1982697467, 3278962783, 278963782, 287678311},
    };
