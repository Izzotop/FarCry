...
public:
    ...
    int GetProfilerCount() const {
        return (int)m_profilers.size();
    };
...
struct CFrameProfileSystem : public IFrameProfileSystem {
    ...
    virtual int GetProfilerCount() const {
        return 0;
    }
