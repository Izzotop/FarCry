...
#define GET_ANIM_MANAGER(pAnimationManager)                                                                                                                                        \
    ICryCharManager* pAnimationManager = getAnimationManager();                                                                                                                    \
...
CScriptObjectAnimation::CScriptObjectAnimation() {}
...
int CScriptObjectAnimation::Start2Anims(IFunctionHandler* pH) {
    ...
    case 5: {
        ...
        if (!pH->GetParam(1, sa[0].nLayer) || !pH->GetParam(2, sa[0].szAnimName) || !pH->GetParam(3, sa[1].nLayer) || !pH->GetParam(4, sa[1].szAnimName) ||
