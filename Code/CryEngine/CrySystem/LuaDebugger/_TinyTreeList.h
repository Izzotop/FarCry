...
public:
    ...
    BOOL Create(ULONG nID = 0, const RECT* pRect = nullptr, _TinyWindow* pParentWnd = nullptr) {
        if (!_TinyWindow::Create(nullptr, _T(""), WS_CHILD | WS_VISIBLE, nullptr, pRect, pParentWnd, nID))
            return FALSE;
