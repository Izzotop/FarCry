...
public:
    ...
    BOOL Create(ULONG nID = 0, const _TinyRect* pRect = nullptr, _TinyWindow* pParentWnd = nullptr) {
        if (!_TinyWindow::Create(STATUSCLASSNAME, _T(""), WS_CHILD | WS_VISIBLE | SBARS_SIZEGRIP, 0, pRect, pParentWnd, nID)) {
