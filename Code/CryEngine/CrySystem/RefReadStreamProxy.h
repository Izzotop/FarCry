...
public:
    ...
    const StreamReadParams& GetParams() const {
        return m_Params;
    }
...
protected:
    ...
    static VOID CALLBACK FileIOCompletionRoutine(DWORD dwErrorCode,               // completion code
