...
public:
    ...
    CacheRW() : m_pFile(nullptr), m_pHeap(nullptr), m_nFlags(0), m_lCDROffset(0) {}
...
public:
    ...
    FileEntryTransactionAdd(class CacheRW* pCache, const char* szRelativePath) : m_pCache(pCache), m_szRelativePath(szRelativePath), m_bComitted(false) {
