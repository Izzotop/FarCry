...
CryBoneHierarchyLoader::CryBoneHierarchyLoader()
    :
      ...
      m_arrBones("CryBoneHierarchyLoader.Bones"), m_arrIdToIndex("CryBoneHierarchyLoader.indexidmaps"), m_arrIndexToId("CryBoneHierarchyLoader.indexidmaps"),
#endif
      m_pChunkBoneAnim(nullptr), m_pChunkBoneAnimSize(0),

      m_pBoneAnimRawData(nullptr), m_pBoneAnimRawDataEnd(nullptr), m_szLastError("") {
}
