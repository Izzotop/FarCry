...
struct ConvertContext {
    ...
    CString getSourcePath() {
        return masterFolder + Path::Make(sourceFolder, sourceFile);
    }
    CString getOutputPath() {
        return masterFolder + Path::Make(outputFolder, outputFile);
    }
    CString getOutputFolderPath() {
        return masterFolder + outputFolder;
    }
