...
struct CryChunkedFile : public _reference_target_t {
    ...
    int GetFileType() const {
        return /*(FileTypes)*/ pFileHeader->FileType;
    }
    ...
    bool IsBoneInitialPosPresent() {
        return Bones.hasInitPos();
    }
