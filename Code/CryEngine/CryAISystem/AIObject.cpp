...
CAIObject::CAIObject() : m_bNeedsPathIndoor(true), m_bNeedsPathOutdoor(true), m_bForceTargetPos(false), m_vBoundPosition(0, 0, 0), m_bIsBoind(false), m_fPassRadius(0.6f) {
...
void CAIObject::Reset() {
    m_pLastNode = 0;
}

float CAIObject::GetEyeHeight() {
    return m_fEyeHeight;
}

// returns the state of this object
SOBJECTSTATE* CAIObject::GetState() {
    return &m_State;
}
