...
public:
    ...
    AgentParameters GetPuppetParameters() {
        return GetParameters();
    }
    void SetPuppetParameters(AgentParameters& pParams) {
    ...
    void GetAgentParams(AgentParameters& params) {
        params = m_Parameters;
    }
    void GetCurrentGoalName(string& name) {
        if (m_pCurrentGoalPipe)
            name = m_pCurrentGoalPipe->m_sName;
        else
            name = "";
    }
