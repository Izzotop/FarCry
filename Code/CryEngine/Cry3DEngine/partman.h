...
struct PartProcessParams {
    PartProcessParams() {
        memset(this, 0, sizeof(PartProcessParams));
    }
...
class CParticle {
public:
    enum EAdvancedParticleFlags { PARTICLE_COLOR_BASED = 0x10000, PARTICLE_ADDITIVE = 0x20000, PARTICLE_ANIMATED_TEXTURE = 0x40000 };
    ...
    Vec3 Color2Vec(unsigned int c) {
        return Vec3(((unsigned char)(c)) * 0.00392156f, ((unsigned char)(c >> 8)) * 0.00392156f, ((unsigned char)(c >> 16)) * 0.00392156f);
    }
};
...
public:
    ...
    int FillTailVertBuffer(SColorVert* pTailVerts, const Vec3d& vCamVec, const UCol& ucColor);
};
...
public:
    ...
    // Particles timing.
    //////////////////////////////////////////////////////////////////////////
    float GetParticlesTime() const {
        return m_currParticlesTime;
    };
    float GetParticlesFrameTime() const {
        return m_currParticlesFrameTime;
    };
