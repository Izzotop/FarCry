...
void CTerrain::InitTerrainWater(bool bEditorMode, IShader* pTerrainWaterShader, int nWaterBottomTexId, IShader* pSunRoadShader, float fWaterTranspRatio, float fWaterReflectRatio,
    ...
    delete m_pWater;
    m_pWater = new CWaterOcean(pTerrainWaterShader, nWaterBottomTexId, pSunRoadShader, fWaterTranspRatio, fWaterReflectRatio, fWaterBumpAmountX, fWaterBumpAmountY,
                               fWaterBorderTranspRatio);
    if (nFogId)
