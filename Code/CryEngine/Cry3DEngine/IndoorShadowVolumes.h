...
public:
    ...
    Vec3d* GetSysVertBufer() {
        return m_pSystemVertexBuffer;
    }
    ...
    IStencilShadowConnectivity*& GetEdgeConnectivity() {
        return m_pEdgeConnectivity;
    }
