...
public:
    ...
    const char* GetEntityClassName() const { return "StatObjInst"; }
    ...
    bool IsEntityHasSomethingToRender() { return true; }
    bool IsEntityAreasVisible() { return true; }
    IPhysicalEntity* GetPhysics() const { return m_pPhysEnt; }
    void SetPhysics(IPhysicalEntity* pPhysEnt) { m_pPhysEnt = pPhysEnt; }
    void SetMaterial(IMatInfo*) {}
    IMatInfo* GetMaterial() const { return nullptr; }
