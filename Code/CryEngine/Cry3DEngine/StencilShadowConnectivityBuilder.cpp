...
CStencilShadowConnectivityBuilder::CStencilShadowConnectivityBuilder()
#ifdef DEBUG_STD_CONTAINERS
    : m_mapSingleEdges("CStencilShadowConnectivityBuilder.SingleEdges"), m_vDoubleEdges("CStencilShadowConnectivityBuilder.DoubleEdges"),
      m_vFaces("CStencilShadowConnectivityBuilder.Faces"), m_mVertexWelder("CStencilShadowConnectivityBuilder.VertexWelder")
#endif
{
    Reinit();
}
...
void CStencilShadowConnectivityBuilder::Reinit() {
...
// coordinates
void CStencilShadowConnectivityBuilder::AddTriangleWelded(unsigned short nV0, unsigned short nV1, unsigned short nV2, const Vec3d& vV0, const Vec3d& vV1, const Vec3d& vV2) {
...
///////////////////////////////////////////////////////////////////////////////////
IStencilShadowConnectivity* CStencilShadowConnectivityBuilder::ConstructConnectivity() {
...
void CStencilShadowStaticConnectivityBuilder::Reinit() {
...
void CStencilShadowStaticConnectivityBuilder::AddTriangleWelded(vindex nV0, vindex nV1, vindex nV2, const Vec3d& vV0, const Vec3d& vV1, const Vec3d& vV2) {
