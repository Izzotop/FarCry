...
#define INIT_CVAR_CHEAT(_var, _def_val, _comment) (_var) = GetConsole()->Register((#_var), &(_var), (_def_val), VF_CHEAT, _comment);

// can be changed in options menu, will be saved into ini file
#define INIT_CVAR_SER__(_var, _def_val, _comment) (_var) = GetConsole()->Register((#_var), &(_var), (_def_val), (e_allow_cvars_serialization ? VF_DUMPTODISK : 0), _comment);
...
#define INIT_CVAR_PUBL_(_var, _def_val, _comment) (_var) = GetConsole()->Register((#_var), &(_var), (_def_val), 0, _comment);
