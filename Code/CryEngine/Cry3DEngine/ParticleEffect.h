...
public:
    ...
    //////////////////////////////////////////////////////////////////////////
    ParticleParams& GetParticleParams(int process) {
        return m_particleParams[process];
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    const char* GetTexture(int process) const {
        return m_texture[process].c_str();
    };
    const char* GetGeometry(int process) const {
        return m_geometry[process].c_str();
    };
    ...
    IMatInfo* GetMaterial(int process) const {
        return m_pMaterials[process];
    };
