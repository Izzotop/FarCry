...
public:
    ...
    CVegetationObject* GetObject(int i) {
        return m_objects[i];
    }
    ...
    int ExportObject(CVegetationObject* object, XmlNodeRef& node, CRect* saveRect = nullptr);
    ...
    //! @param brush Object to remove, if nullptr all object will be cleared.
    ...
    void SetUpdateOnPaintBrightness(bool bOn) {
        m_bUpdateOnPaintBrightness = bOn;
    };
    ...
    void SerializeInstances(CXmlArchive& xmlAr, CRect* rect = nullptr);
