...
int CRollupBar::OnCreate(LPCREATESTRUCT lpCreateStruct) {
    ...
    m_tab.InsertItem(0, nullptr, 0);
    m_tab.InsertItem(1, nullptr, 1);
    m_tab.InsertItem(2, nullptr, 2);
    m_tab.InsertItem(3, nullptr, 3);
...
void CRollupBar::OnSize(UINT nType, int cx, int cy) {
    ...
    m_tab.MoveWindow(rcRollUp.left, rcRollUp.top, rcRollUp.right, rcRollUp.bottom);
