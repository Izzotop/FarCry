...
void CPropertyItem::CreateInPlaceControl(CWnd* pWndParent, CRect& ctrlRect) {
    ...
    case ePropertyAngle: {
        ...
        m_cNumber->Create(pWndParent, nullptrRc, 1, CNumberCtrl::NOBORDER | CNumberCtrl::LEFTALIGN);
    ...
    case ePropertyLocalString:
        ...
        m_cEdit->Create(WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT, nullptrRc, pWndParent, 2);
        break;
    ...
    case ePropertyEAXPreset:
        ...
        if (m_type == ePropertyShader) {
            ...
            m_cButton->Create("...", WS_CHILD | WS_VISIBLE, nullptrRc, pWndParent, 4);
        }
    ...
    case ePropertySelection: {
        ...
        m_cCombo->Create(nullptr, "", WS_CHILD | WS_VISIBLE, nullptrRc, pWndParent, 2);
...
void CPropertyItem::DrawValue(CDC* dc, CRect rect) {
    ...
    if (m_type == ePropertyList) {
        ...
        textRc = rect;
        textRc.left += 15;
        ::DrawTextEx(dc->GetSafeHdc(), str, strlen(str), textRc, DT_END_ELLIPSIS | DT_LEFT | DT_SINGLELINE | DT_VCENTER, nullptr);
        strcpy(str, "");
    } else if (m_type == ePropertyFile || m_type == ePropertyTexture || m_type == ePropertySound || m_type == ePropertyModel) {
        // Any file.
...
void CPropertyItem::OnColorBrowseButton() {
    ...
    if (GetIEditor()->SelectColor(clr, m_propertyCtrl)) {
        ...
        SetValue(val);
        m_propertyCtrl->Invalidate();
        // RedrawWindow( OwnerProperties->hWnd,nullptr,nullptr,RDW_INVALIDATE|RDW_UPDATENOW|RDW_ALLCHILDREN );
    }
}
