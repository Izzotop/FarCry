...
public:
    ...
    */
    ...
    /** FindNextItem traverses a tree searching for an item matching all the item attributes set in a TV_ITEM structure.
                    ...
                    If a match is found, the function returns the handle otherwise nullptr.
                    The function only searches in one direction (down) and if hItem is nullptr starts from the root of the tree.
    */
    ...
    */
     ...
     */
    void SetOnlyLeafsDrag(bool bEnable) {
        m_bOnlyLeafsDrag = bEnable;
    }
