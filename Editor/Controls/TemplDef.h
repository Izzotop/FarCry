...
#define BEGIN_TEMPLATE_MESSAGE_MAP(theTemplArgs, theClass, baseClass)                                                                                                              \
    template <theTemplArgs> const AFX_MSGMAP* PASCAL theClass::_GetBaseMessageMap() { return &baseClass::messageMap; }                                                             \
    template <theTemplArgs> const AFX_MSGMAP* theClass::GetMessageMap() const { return &theClass::messageMap; }                                                                    \
    template <theTemplArgs> /*AFX_COMDAT AFX_DATADEF*/ const AFX_MSGMAP theClass::messageMap = {&theClass::_GetBaseMessageMap, &theClass::_messageEntries[0]};                     \
    template <theTemplArgs> /*AFX_COMDAT */ const AFX_MSGMAP_ENTRY theClass::_messageEntries[] = {
#else
#define BEGIN_TEMPLATE_MESSAGE_MAP(theTemplArgs, theClass, baseClass)                                                                                                              \
    template <theTemplArgs> const AFX_MSGMAP* theClass::GetMessageMap() const { return &theClass::messageMap; }                                                                    \
    template <theTemplArgs> /*AFX_COMDAT */ AFX_DATADEF const AFX_MSGMAP theClass::messageMap = {&baseClass::messageMap, &theClass::_messageEntries[0]};                           \
    template <theTemplArgs> /*AFX_COMDAT */ const AFX_MSGMAP_ENTRY theClass::_messageEntries[] = {
...
#ifdef _AFXDLL
#define BEGIN_TEMPLATE_MESSAGE_MAP(theTemplArgs, theClass, baseClass)                                                                                                              \
    template <theTemplArgs> const AFX_MSGMAP* PASCAL theClass::GetThisMessageMap() { return &theClass::messageMap; }                                                               \
    template <theTemplArgs> const AFX_MSGMAP* theClass::GetMessageMap() const { return &theClass::messageMap; }                                                                    \
    template <theTemplArgs> /*AFX_COMDAT AFX_DATADEF*/ const AFX_MSGMAP theClass::messageMap = {&baseClass::GetThisMessageMap, &theClass::_messageEntries[0]};                     \
    template <theTemplArgs> /*AFX_COMDAT */ const AFX_MSGMAP_ENTRY theClass::_messageEntries[] = {
