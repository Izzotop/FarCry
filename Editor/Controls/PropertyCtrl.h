...
public:
    ...
    void Create(DWORD dwStyle, const CRect& rc, CWnd* pParent = nullptr, UINT nID = 0);
    ...
    /** Add more variables.
                    @param szCategory Name of category to place var block, if nullptr do not create new category.
                    @return Root item where this var block was added.
    */
    CPropertyItem* AddVarBlock(CVarBlock* varBlock, const char* szCategory = nullptr);

    /** Set update callback to be used for this property window.
     */
    void SetUpdateCallback(UpdateCallback& callback) {
        m_updateFunc = callback;
    }

    /** Set update callback to be used for this property window.
     */
    void SetUpdateCallback(UpdateVarCallback& callback) {
     ...
     */
    CPropertyItem* GetRootItem() const {
        return m_root;
    };
    ...
    void SetDisplayOnlyModified(bool bEnable) {
        m_bDisplayOnlyModified = bEnable;
    };
