...
CEquipPackDialog::CEquipPackDialog(CWnd* pParent /*=nullptr*/) : CDialog(CEquipPackDialog::IDD, pParent) {
    m_sCurrEquipPack = "";
}
...
BOOL CEquipPackDialog::OnInitDialog() {
    ...
    if (weaponIter) {
        ...
        AfxMessageBox("GetAvailableWeaponNames() returned nullptr. Unable to retrieve weapons.", MB_ICONEXCLAMATION | MB_OK);
