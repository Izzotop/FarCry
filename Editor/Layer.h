...
public:
    ...
    // Slope
    float GetLayerMinSlope() {
        return m_minSlope;
    };
    float GetLayerMaxSlope() {
        return m_maxSlope;
    };
    void SetLayerMinSlope(float min) {
        m_minSlope = min;
        InvalidateMask();
    };
    void SetLayerMaxSlope(float max) {
        m_maxSlope = max;
        InvalidateMask();
    };
    ...
    // Altitude
    UINT GetLayerStart() {
        return m_iLayerStart;
    };
    UINT GetLayerEnd() {
        return m_iLayerEnd;
    };
    void SetLayerStart(UINT iStart) {
        m_iLayerStart = iStart;
        InvalidateMask();
    };
    void SetLayerEnd(UINT iEnd) {
        m_iLayerEnd = iEnd;
        InvalidateMask();
    };
    ...
    // Layer Mask
    //////////////////////////////////////////////////////////////////////////
    unsigned char GetLayerMaskPoint(uint x, uint y) {
        return m_layerMask.ValueAt(x, y);
    }
    void SetLayerMaskPoint(uint x, uint y, unsigned char c) {
        m_layerMask.ValueAt(x, y) = c;
    }
    ...
    //////////////////////////////////////////////////////////////////////////
    int GetMaskResolution() const {
        return m_maskResolution;
    };

    // Texture
    int GetTextureWidth() {
        return m_cTextureDimensions.cx;
    };
    int GetTextureHeight() {
        return m_cTextureDimensions.cy;
    };
    CSize GetTextureDimensions() {
    ...
    bool HasTexture() {
        return GetTextureWidth() != nullptr;
    };

    uint& GetTexturePixel(int x, int y) {
        return m_texture.ValueAt(x, y);
    };
    ...
    bool IsValid() {
        return m_layerMask.IsValid();
    }

    // In use
    bool IsInUse() {
        return m_bLayerInUse;
    };
    void SetInUse(bool bNewState) {
        m_bLayerInUse = bNewState;
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    void SetSurfaceType(const CString& sfType) {
        m_surfaceType = sfType;
    }
    CString GetSurfaceType() {
