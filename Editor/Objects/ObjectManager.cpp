...
public:
    ...
    CRuntimeClass* GetRuntimeClass() {
        return superType->GetRuntimeClass();
    };
...
public:
    CUndoBaseObjectNew(CBaseObject* obj) {
        m_object = obj;
    }
