...
protected:
    ...
    virtual bool IsOnlyUpdateOnUnselect() const {
        return false;
    }
...
public:
    ...
    CRuntimeClass* GetRuntimeClass() {
        return RUNTIME_CLASS(CShapeObject);
    };
...
public:
    ...
    CRuntimeClass* GetRuntimeClass() {
        return RUNTIME_CLASS(CAIForbiddenAreaObject);
    };
    int GameCreationOrder() {
        return 50;
    };
...
public:
    ...
    CRuntimeClass* GetRuntimeClass() {
        return RUNTIME_CLASS(CAIPathObject);
    };
    int GameCreationOrder() {
        return 50;
    };
...
public:
    ...
    const char* ClassName() {
        return "AINavigationModifier";
    };
    const char* Category() {
        return "AI";
    };
    CRuntimeClass* GetRuntimeClass() {
        return RUNTIME_CLASS(CAINavigationModifierObject);
    };
    int GameCreationOrder() {
        return 50;
    };
...
public:
    REFGUID ClassID() {
        ...
        static const GUID guid = {0x85f4feb1, 0x1e97, 0x4d78, {0xbc, 0xf, 0xca, 0xce, 0xa0, 0xd5, 0x39, 0xc3}};
        return guid;
    }
    ObjectType GetObjectType() {
        return OBJTYPE_SHAPE;
    ...
    const char* ClassName() {
        return "AIHorizontalOcclusionPlane";
    };
    const char* Category() {
        return "AI";
    };
    CRuntimeClass* GetRuntimeClass() {
        return RUNTIME_CLASS(CAIOcclusionPlaneObject);
    };
    int GameCreationOrder() {
        return 50;
    };
