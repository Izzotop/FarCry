...
public:
    ...
    std::vector<ObjectHelper>& GetHelpers() {
        return m_helpers;
    };
    void SpawnEntities();
...
public:
    ...
    CRuntimeClass* GetRuntimeClass() {
        return RUNTIME_CLASS(CBuilding);
    };
    const char* GetFileSpec() {
        return "Objects\\Buildings\\*.bld";
    };
};
