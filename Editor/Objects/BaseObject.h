...
public:
    ...
    CObjectClassDesc* GetClassDesc() const {
        return m_classDesc;
    };
    ...
    bool CheckFlags(int flags) const {
    ...
    bool IsSelected() const {
        return CheckFlags(OBJFLAG_SELECTED);
    }
    //! Returns true if object is shared between missions.
    bool IsShared() const {
        return CheckFlags(OBJFLAG_SHARED);
    }
    ...
    bool IsHighlighted() const {
        return CheckFlags(OBJFLAG_HIGHLIGHT);
    }
    ...
    Vec3 GetWorldPos() const {
        return GetWorldTM().GetTranslationOLD();
    };
    ...
    virtual struct IAnimNode* GetAnimNode() const {
        return 0;
    };

    //! Gets physics collision entity of this object.
    virtual class IPhysicalEntity* GetCollisionEntity() const {
        return 0;
    };
