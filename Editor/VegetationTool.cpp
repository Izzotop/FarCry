...
void CVegetationTool::PaintBrush() {
    ...
    CRect rc(m_pointerPos.x - m_brushRadius, m_pointerPos.y - m_brushRadius, m_pointerPos.x + m_brushRadius, m_pointerPos.y + m_brushRadius);
    if (m_bPlaceMode) {
