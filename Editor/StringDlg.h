...
class CStringDlg : public CDialog {
    // Construction
public:
    CStringDlg(const char* title = nullptr, CWnd* pParent = nullptr); // standard constructor
...
class CStringGroupDlg : public CDialog {
    // Construction
public:
    CStringGroupDlg(const char* title = nullptr, CWnd* pParent = nullptr); // standard constructor
