...
CSrcSafeSettingsDialog::CSrcSafeSettingsDialog(CWnd* pParent /*=nullptr*/)
    : CDialog(CSrcSafeSettingsDialog::IDD, pParent), m_username(_T("")), m_exeFile(_T("")), m_database(_T("")), m_project(_T("")) {}
...
void CSrcSafeSettingsDialog::OnBnClickedBrowseExe() {
    ...
    CFileDialog dlgFile(TRUE, nullptr, m_exeFile, OFN_ENABLESIZING | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_PATHMUSTEXIST | OFN_NOCHANGEDIR, szFilters);
...
void CSrcSafeSettingsDialog::OnBnClickedBrowseDatabase() {
    ...
    CFileDialog dlgFile(TRUE, nullptr, m_database, OFN_ENABLESIZING | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_PATHMUSTEXIST | OFN_NOCHANGEDIR, szFilters);
    if (dlgFile.DoModal() == IDOK) {
