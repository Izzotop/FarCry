...
public:
    ...
    void SetUpdateRegion(const BBox& updateRegion) {
        m_updateRegion = updateRegion;
    };
    const BBox& GetUpdateRegion() {
    ...
    REFGUID GetCameraObjectId() const {
        return m_cameraObjectId;
    };
    //! Sets currently active camera object id.
    void SetCameraObjectId(REFGUID cameraObjectId) {
    ...
    virtual CViewport* GetView(int index) {
