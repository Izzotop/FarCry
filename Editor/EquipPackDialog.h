...
public:
    void SetCurrEquipPack(CString& sValue) {
        m_sCurrEquipPack = sValue;
    }
    CString GetCurrEquipPack() {
        return m_sCurrEquipPack;
    }

public:
    CEquipPackDialog(CWnd* pParent = nullptr); // standard constructor
