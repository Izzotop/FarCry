...
CStringDlg::CStringDlg(const char* title, CWnd* pParent /*=nullptr*/) : CDialog(CStringDlg::IDD, pParent) {
...
CStringGroupDlg::CStringGroupDlg(const char* title, CWnd* pParent /*=nullptr*/) : CDialog(CStringGroupDlg::IDD, pParent) {
    m_strString = _T("");
    m_strGroup = _T("");
