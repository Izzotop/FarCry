...
public:
    ...
    virtual void SetViewMode(ViewMode eViewMode) {
    ...
    virtual CRect GetSelectionRectangle() const {
    ...
    float GetSelectionTolerance() const {
        return m_selectionTollerance;
    }
    ...
    virtual bool IsAVIRecordingPaused() const {
        return m_bAVIPaused;
    };
...
protected:
    ...
    void SetViewManager(CViewManager* viewMgr) {
