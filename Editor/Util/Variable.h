...
inline const char* to_c_str(const string& str) {
    return str.c_str();
}
inline const char* to_c_str(const CString& str) {
    return str;
}
...
public:
    ...
    void SetHumanName(const CString& name) {
        m_humanName = name;
    }
    ...
    const char* GetDescription() const {
        return to_c_str(m_description);
    };

    EType GetType() const {
        return IVariable::UNKNOWN;
    };
    int GetSize() const {
        return sizeof(*this);
    };
    ...
    void Get(Vec3& value) const {
        assert(0);
    }
    void Get(Quat& value) const {
        assert(0);
    }
    void Get(CString& value) const {
        assert(0);
    }
    ...
    virtual IVarEnumList* GetEnumList() const {
        return 0;
    };
...
namespace var_type {
//////////////////////////////////////////////////////////////////////////
template <int TypeID, bool IsStandart, bool IsInteger, bool IsSigned> struct type_traits_base {
    static int type() {
        return TypeID;
    };
...
template <class Type> struct type_traits : public type_traits_base<IVariable::UNKNOWN, false, false, false> {};
...
//////////////////////////////////////////////////////////////////////////
template <class From, class To> struct type_convertor {
...
//////////////////////////////////////////////////////////////////////////
template <> void type_convertor<int, int>::operator()(const int& from, int& to) const {
    to = from;
}
template <> void type_convertor<int, bool>::operator()(const int& from, bool& to) const {
    to = from != 0;
}
template <> void type_convertor<int, float>::operator()(const int& from, float& to) const {
    to = (float)from;
}
//////////////////////////////////////////////////////////////////////////
template <> void type_convertor<bool, int>::operator()(const bool& from, int& to) const {
    to = from;
}
template <> void type_convertor<bool, bool>::operator()(const bool& from, bool& to) const {
    to = from;
}
template <> void type_convertor<bool, float>::operator()(const bool& from, float& to) const {
    to = from;
}
//////////////////////////////////////////////////////////////////////////
template <> void type_convertor<float, int>::operator()(const float& from, int& to) const {
    to = (int)from;
}
template <> void type_convertor<float, bool>::operator()(const float& from, bool& to) const {
    to = from != 0;
}
template <> void type_convertor<float, float>::operator()(const float& from, float& to) const {
    to = from;
}

template <> void type_convertor<Vec3, Vec3>::operator()(const Vec3& from, Vec3& to) const {
    to = from;
}
template <> void type_convertor<Quat, Quat>::operator()(const Quat& from, Quat& to) const {
    to = from;
}
template <> void type_convertor<CString, CString>::operator()(const CString& from, CString& to) const {
    to = from;
}
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
template <class Type> inline bool compare(const Type& arg1, const Type& arg2) {
    return arg1 == arg2;
};
...
//////////////////////////////////////////////////////////////////////////
template <class Type> inline void init(Type& val) {
    val = 0;
};
...
//////////////////////////////////////////////////////////////////////////
template <class T> class CVariable : public CVariableBase {
...
public:
    ...
    //! Get name of parameter.
    virtual EType GetType() const {
        return (EType)var_type::type_traits<T>::type();
    };
    virtual int GetSize() const {
        return sizeof(T);
    };
...
protected:
    ...
    //////////////////////////////////////////////////////////////////////////
    template <class P> void SetValue(const P& value) {
        T newValue;
    ...
    //////////////////////////////////////////////////////////////////////////
    template <class P> void GetValue(P& value) const {
...
//////////////////////////////////////////////////////////////////////////
//! Selection list shown in combo box, for enumerated variable.
template <class T> class CVarEnumList : public IVarEnumList {
public:
    struct Item {
        CString name;
        T value;
...
//////////////////////////////////////////////////////////////////////////////////
template <class T> class CVariableEnum : public CVariable<T> {
public:
    //////////////////////////////////////////////////////////////////////////
    CVariableEnum(){};
...
public:
    ...
    void AddVariable(CVariableBase& var, const CString& varName, VarOnSetCallback cb = nullptr, unsigned char dataType = IVariable::DT_SIMPLE);
    void AddVariable(CVariableBase& var, const CString& varName, const CString& varHumanName, VarOnSetCallback cb = nullptr, unsigned char dataType = IVariable::DT_SIMPLE);
    void ReserveNumVariables(int numVars);
