...
template <class Callee, class MemFunc> class CBMemberTranslator0 : public Functor0 {
public:
    CBMemberTranslator0(Callee& c, const MemFunc& m) : Functor0(thunk, &c, 0, &m, sizeof(MemFunc)) {}
    static void thunk(const FunctorBase& ftor) {
        Callee* callee = (Callee*)ftor.getCallee();
        MemFunc& memFunc RHCB_CTOR_STYLE_INIT(*(MemFunc*)(void*)(ftor.getMemFunc()));
        (callee->*memFunc)();
    }
};
...
template <class Callee, class RT, class CallType> inline CBMemberTranslator0<Callee, RT (CallType::*)()> functor(Callee& c, RT (CallType::*RHCB_CONST_REF f)()) {
...
inline CBMemberTranslator0<const Callee, RT (CallType::*)() const> functor(const Callee& c, RT (CallType::*RHCB_CONST_REF f)() const) {
    typedef RT (CallType::*MemFunc)() const;
    return CBMemberTranslator0<const Callee, MemFunc>(c, f);
}

template <class RT> inline CBFunctionTranslator0<RT (*)()> functor(RT (*f)()) {
...
protected:
    ...
    Functor1(Thunk t, const void* c, PFunc f, const void* mf, size_t sz) : FunctorBase(c, f, mf, sz), thunk(t) {}

private:
    Thunk thunk;
};

template <class P1, class Callee, class MemFunc> class CBMemberTranslator1 : public Functor1<P1> {
public:
    CBMemberTranslator1(Callee& c, const MemFunc& m) : Functor1<P1>(thunk, &c, 0, &m, sizeof(MemFunc)) {}
...
template <class P1, class Func> class CBFunctionTranslator1 : public Functor1<P1> {
public:
...
#if !defined(RHCB_CANT_OVERLOAD_ON_CONSTNESS)
template <class P1, class Callee, class CallType> inline CBMemberTranslator1<P1, Callee, void (CallType::*)(P1)> functor(Callee& c, void (CallType::*RHCB_CONST_REF f)(P1)) {
...
inline CBMemberTranslator1<P1, const Callee, RT (CallType::*)(P1) const> functor(const Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1) const) {
    typedef RT (CallType::*MemFunc)(P1) const;
    return CBMemberTranslator1<P1, const Callee, MemFunc>(c, f);
}

template <class RT, class P1> inline CBFunctionTranslator1<P1, RT (*)(P1)> functor(RT (*f)(P1)) {
    return CBFunctionTranslator1<P1, RT (*)(P1)>(f);
}

template <class P1, class MemFunc> class CBMemberOf1stArgTranslator1 : public Functor1<P1> {
public:
    CBMemberOf1stArgTranslator1(const MemFunc& m) : Functor1<P1>(thunk, (void*)1, 0, &m, sizeof(MemFunc)) {}
    static void thunk(const FunctorBase& ftor, P1 p1) {
        MemFunc& memFunc RHCB_CTOR_STYLE_INIT(*(MemFunc*)(void*)(ftor.getMemFunc()));
        (p1.*memFunc)();
    }
...
#if !defined(RHCB_CANT_OVERLOAD_ON_CONSTNESS)
template <class RT, class P1, class CallType> inline CBMemberOf1stArgTranslator1<P1, RT (CallType::*)()> functor(RT (CallType::*RHCB_CONST_REF f)()) {
    typedef RT (CallType::*MemFunc)();
    return CBMemberOf1stArgTranslator1<P1, MemFunc>(f);
}
#endif

template <class RT, class P1, class CallType> inline CBMemberOf1stArgTranslator1<P1, RT (CallType::*)() const> functor(RT (CallType::*RHCB_CONST_REF f)() const) {
    typedef RT (CallType::*MemFunc)() const;
    return CBMemberOf1stArgTranslator1<P1, MemFunc>(f);
}
/************************* one arg - with return *******************/
...
protected:
    ...
    Functor2(Thunk t, const void* c, PFunc f, const void* mf, size_t sz) : FunctorBase(c, f, mf, sz), thunk(t) {}

private:
    Thunk thunk;
};

template <class P1, class P2, class Callee, class MemFunc> class CBMemberTranslator2 : public Functor2<P1, P2> {
public:
    CBMemberTranslator2(Callee& c, const MemFunc& m) : Functor2<P1, P2>(thunk, &c, 0, &m, sizeof(MemFunc)) {}
...
template <class P1, class P2, class Func> class CBFunctionTranslator2 : public Functor2<P1, P2> {
public:
...
inline CBMemberTranslator2<P1, P2, Callee, RT (CallType::*)(P1, P2)> functor(Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1, P2)) {
...
template <class Callee, class RT, class CallType, class P1, class P2>
inline CBMemberTranslator2<P1, P2, const Callee, RT (CallType::*)(P1, P2) const> functor(const Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1, P2) const) {
    typedef RT (CallType::*MemFunc)(P1, P2) const;
    return CBMemberTranslator2<P1, P2, const Callee, MemFunc>(c, f);
}

template <class RT, class P1, class P2> inline CBFunctionTranslator2<P1, P2, RT (*)(P1, P2)> functor(RT (*f)(P1, P2)) {
    return CBFunctionTranslator2<P1, P2, RT (*)(P1, P2)>(f);
}

template <class P1, class P2, class MemFunc> class CBMemberOf1stArgTranslator2 : public Functor2<P1, P2> {
public:
    CBMemberOf1stArgTranslator2(const MemFunc& m) : Functor2<P1, P2>(thunk, (void*)1, 0, &m, sizeof(MemFunc)) {}
    static void thunk(const FunctorBase& ftor, P1 p1, P2 p2) {
        MemFunc& memFunc RHCB_CTOR_STYLE_INIT(*(MemFunc*)(void*)(ftor.getMemFunc()));
        (p1.*memFunc)(p2);
    }
...
#if !defined(RHCB_CANT_OVERLOAD_ON_CONSTNESS)
template <class P1, class P2, class RT, class CallType> inline CBMemberOf1stArgTranslator2<P1, P2, RT (CallType::*)(P1)> functor(RT (CallType::*RHCB_CONST_REF f)(P1)) {
    typedef RT (CallType::*MemFunc)(P1);
    return CBMemberOf1stArgTranslator2<P1, P2, MemFunc>(f);
}
#endif

template <class P1, class P2, class RT, class CallType> inline CBMemberOf1stArgTranslator2<P1, P2, RT (CallType::*)(P1) const> functor(RT (CallType::*RHCB_CONST_REF f)(P1) const) {
    typedef RT (CallType::*MemFunc)(P1) const;
    return CBMemberOf1stArgTranslator2<P1, P2, MemFunc>(f);
}
...
protected:
    ...
    Functor3(Thunk t, const void* c, PFunc f, const void* mf, size_t sz) : FunctorBase(c, f, mf, sz), thunk(t) {}

private:
    Thunk thunk;
};

template <class P1, class P2, class P3, class Callee, class MemFunc> class CBMemberTranslator3 : public Functor3<P1, P2, P3> {
public:
    CBMemberTranslator3(Callee& c, const MemFunc& m) : Functor3<P1, P2, P3>(thunk, &c, 0, &m, sizeof(MemFunc)) {}
...
template <class P1, class P2, class P3, class Func> class CBFunctionTranslator3 : public Functor3<P1, P2, P3> {
public:
...
inline CBMemberTranslator3<P1, P2, P3, Callee, RT (CallType::*)(P1, P2, P3)> functor(Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1, P2, P3)) {
...
template <class Callee, class RT, class CallType, class P1, class P2, class P3>
inline CBMemberTranslator3<P1, P2, P3, const Callee, RT (CallType::*)(P1, P2, P3) const> functor(const Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1, P2, P3) const) {
    typedef RT (CallType::*MemFunc)(P1, P2, P3) const;
    return CBMemberTranslator3<P1, P2, P3, const Callee, MemFunc>(c, f);
}

template <class RT, class P1, class P2, class P3> inline CBFunctionTranslator3<P1, P2, P3, RT (*)(P1, P2, P3)> functor(RT (*f)(P1, P2, P3)) {
    return CBFunctionTranslator3<P1, P2, P3, RT (*)(P1, P2, P3)>(f);
}

template <class P1, class P2, class P3, class MemFunc> class CBMemberOf1stArgTranslator3 : public Functor3<P1, P2, P3> {
public:
    CBMemberOf1stArgTranslator3(const MemFunc& m) : Functor3<P1, P2, P3>(thunk, (void*)1, 0, &m, sizeof(MemFunc)) {}
    static void thunk(const FunctorBase& ftor, P1 p1, P2 p2, P3 p3) {
        MemFunc& memFunc RHCB_CTOR_STYLE_INIT(*(MemFunc*)(void*)(ftor.getMemFunc()));
        (p1.*memFunc)(p2, p3);
    }
...
inline CBMemberOf1stArgTranslator3<P1, P2, P3, RT (CallType::*)(P1, P2)> functor(RT (CallType::*RHCB_CONST_REF f)(P1, P2)) {
    typedef RT (CallType::*MemFunc)(P1, P2);
...
template <class P1, class P2, class P3, class RT, class CallType>
inline CBMemberOf1stArgTranslator3<P1, P2, P3, RT (CallType::*)(P1, P2) const> functor(RT (CallType::*RHCB_CONST_REF f)(P1, P2) const) {
    typedef RT (CallType::*MemFunc)(P1, P2) const;
    return CBMemberOf1stArgTranslator3<P1, P2, P3, MemFunc>(f);
}
...
/************************* four args - no return *******************/
template <class P1, class P2, class P3, class P4> class Functor4 : public FunctorBase {
public:
...
protected:
    ...
    Functor4(Thunk t, const void* c, PFunc f, const void* mf, size_t sz) : FunctorBase(c, f, mf, sz), thunk(t) {}

private:
    Thunk thunk;
};

template <class P1, class P2, class P3, class P4, class Callee, class MemFunc> class CBMemberTranslator4 : public Functor4<P1, P2, P3, P4> {
public:
    CBMemberTranslator4(Callee& c, const MemFunc& m) : Functor4<P1, P2, P3, P4>(thunk, &c, 0, &m, sizeof(MemFunc)) {}
...
template <class P1, class P2, class P3, class P4, class Func> class CBFunctionTranslator4 : public Functor4<P1, P2, P3, P4> {
public:
    CBFunctionTranslator4(Func f) : Functor4<P1, P2, P3, P4>(thunk, 0, (PFunc)f, 0, 0) {}
    static void thunk(const FunctorBase& ftor, P1 p1, P2 p2, P3 p3, P4 p4) {
...
inline CBMemberTranslator4<P1, P2, P3, P4, Callee, RT (CallType::*)(P1, P2, P3, P4)> functor(Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1, P2, P3, P4)) {
...
template <class Callee, class RT, class CallType, class P1, class P2, class P3, class P4>
inline CBMemberTranslator4<P1, P2, P3, P4, const Callee, RT (CallType::*)(P1, P2, P3, P4) const> functor(const Callee& c, RT (CallType::*RHCB_CONST_REF f)(P1, P2, P3, P4) const) {
    typedef RT (CallType::*MemFunc)(P1, P2, P3, P4) const;
    return CBMemberTranslator4<P1, P2, P3, P4, const Callee, MemFunc>(c, f);
}

template <class RT, class P1, class P2, class P3, class P4> inline CBFunctionTranslator4<P1, P2, P3, P4, RT (*)(P1, P2, P3, P4)> functor(RT (*f)(P1, P2, P3, P4)) {
    return CBFunctionTranslator4<P1, P2, P3, P4, RT (*)(P1, P2, P3, P4)>(f);
}

template <class P1, class P2, class P3, class P4, class MemFunc> class CBMemberOf1stArgTranslator4 : public Functor4<P1, P2, P3, P4> {
public:
    CBMemberOf1stArgTranslator4(const MemFunc& m) : Functor4<P1, P2, P3, P4>(thunk, (void*)1, 0, &m, sizeof(MemFunc)) {}
    static void thunk(const FunctorBase& ftor, P1 p1, P2 p2, P3 p3, P4 p4) {
        MemFunc& memFunc RHCB_CTOR_STYLE_INIT(*(MemFunc*)(void*)(ftor.getMemFunc()));
        (p1.*memFunc)(p2, p3, p4);
    }
...
inline CBMemberOf1stArgTranslator4<P1, P2, P3, P4, RT (CallType::*)(P1, P2, P3)> functor(RT (CallType::*RHCB_CONST_REF f)(P1, P2, P3)) {
    typedef RT (CallType::*MemFunc)(P1, P2, P3);
...
template <class P1, class P2, class P3, class P4, class RT, class CallType>
inline CBMemberOf1stArgTranslator4<P1, P2, P3, P4, RT (CallType::*)(P1, P2, P3) const> functor(RT (CallType::*RHCB_CONST_REF f)(P1, P2, P3) const) {
    typedef RT (CallType::*MemFunc)(P1, P2, P3) const;
    return CBMemberOf1stArgTranslator4<P1, P2, P3, P4, MemFunc>(f);
}
...
inline bool operator==(const FunctorBase& lhs, const FunctorBase& rhs) {
    if (!lhs.callee) {
        ...
        if (!rhs.callee)
            return false;
        return lhs.callee == rhs.callee && !memcmp(lhs.memFunc, rhs.memFunc, FunctorBase::MEM_FUNC_SIZE);
    }
}
...
//////////////////////////////////////////////////////////////////////////
template <class FUNCTOR> class CFunctorsList {
public:
    // Add functor to list.
    ...
    template <class T1> void Call(const T1& param1) {
        for (Container::iterator it = m_functors.begin(); it != m_functors.end(); ++it) {
            (*it)(param1);
        }
    }

    template <class T1, class T2> void Call(const T1& param1, const T2& param2) {
        for (Container::iterator it = m_functors.begin(); it != m_functors.end(); ++it) {
            (*it)(param1, param2);
        }
    }

    template <class T1, class T2, class T3> void Call(const T1& param1, const T2& param2, const T3& param3) {
        for (Container::iterator it = m_functors.begin(); it != m_functors.end(); ++it) {
