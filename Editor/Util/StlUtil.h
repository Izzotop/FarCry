...
template <class Map, typename mapped_type, typename key_type> inline mapped_type& find_in_map(Map& mapKeyToValue, const key_type& key, mapped_type& valueDefault) {
...
#else  // WIN64
template <class Map> inline Map::mapped_type& find_in_map(Map& mapKeyToValue, const Map::key_type& key, Map::mapped_type& valueDefault) {
    Map::iterator it = mapKeyToValue.find(key);
    if (it == mapKeyToValue.end())
        return valueDefault;
    else {
...
#else  // WIN64
template <class Map> inline const Map::mapped_type& find_in_map(const Map& mapKeyToValue, const Map::key_type& key, const Map::mapped_type& valueDefault) {
    Map::const_iterator it = mapKeyToValue.find(key);
    if (it == mapKeyToValue.end())
        return valueDefault;
    else {
...
//////////////////////////////////////////////////////////////////////////
template <class Map, class Value> inline void map_to_vector(const Map& theMap, std::vector<Value>& array) {
    array.clear();
