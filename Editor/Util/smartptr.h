...
//
///////////////////////////////////////////////////////////////////////////////
template <class Type> class TSmartPtr {
    Type* p;
...
public:
    ...
    TSmartPtr(int nullptr) : p(nullptr) {}
    ~TSmartPtr() {
        if (p)
            (p)->Release();
    }
    ...
    bool operator==(const TSmartPtr<Type>& p2) const {
        return p == p2.p;
    };
    bool operator!=(const TSmartPtr<Type>& p2) const {
        return p != p2.p;
    ...
    friend bool operator==(const TSmartPtr<Type>& p1, int nullptr);
    friend bool operator!=(const TSmartPtr<Type>& p1, int nullptr);
    friend bool operator==(int nullptr, const TSmartPtr<Type>& p1);
    friend bool operator!=(int nullptr, const TSmartPtr<Type>& p1);
};
#endif // WIN64

#ifndef WIN64
template <class T> inline bool operator==(const TSmartPtr<T>& p1, int nullptr) {
    return p1.p == 0;
}
...
template <class T> inline bool operator==(int nullptr, const TSmartPtr<T>& p1) {
    return p1.p == 0;
}
