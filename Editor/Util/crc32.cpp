...
unsigned int Crc32Gen::reflect(unsigned int ref, char ch) { // Used only by Init_CRC32_Table().
...
unsigned int Crc32Gen::get_CRC32(const char* data, int size, unsigned int ulCRC) { // Pass a text string to this function and it will return the CRC.
