...
enum EThreadWaitStatus { THREAD_WAIT_FAILED, THREAD_WAIT_ABANDONED, THREAD_WAIT_OBJECT_0, THREAD_WAIT_TIMEOUT, THREAD_WAIT_IO_COMPLETION };
...
//
template <class T> class CRYEDIT_API MTDeque {
public:
