...
static struct {
    ...
    {EFTT_DIFFUSE, "Diffuse"},       {EFTT_GLOSS, "Specular"},  {EFTT_BUMP, "Bumpmap"},        {EFTT_NORMALMAP, "Normalmap"},   {EFTT_CUBEMAP, "Cubemap"},
    {EFTT_DETAIL_OVERLAY, "Detail"}, {EFTT_OPACITY, "Opacity"}, {EFTT_DECAL_OVERLAY, "Decal"}, {EFTT_SUBSURFACE, "SubSurface"},
};
...
private:
    ...
    Vec3 ToVec3(const CFColor& col) {
        return Vec3(col.r, col.g, col.b);
    }
    CFColor ToCFColor(const Vec3& col) {
        return CFColor(col);
    }
};
...
//////////////////////////////////////////////////////////////////////////
CMaterialDialog::CMaterialDialog(CWnd* pParent) : CBaseLibraryDialog(IDD_DB_ENTITY, pParent) {
...
void CMaterialDialog::OnUpdateProperties(IVariable* var) {
    ...
    //////////////////////////////////////////////////////////////////////////
    if (m_shaderGenParamsVarsItem != nullptr && m_shaderGenParamsVars != nullptr && !bShaderChanged) {
