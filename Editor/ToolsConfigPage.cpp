...
CToolsConfigPage::CToolsConfigPage() : CXTResizePropertyPage(CToolsConfigPage::IDD) {
    ...
    m_editList.SetListEditStyle(_T(" &Tools:"), LBS_XT_DEFAULT);
}
...
void CToolsConfigPage::OnSelchangeEditList() {
    ...
    if (pTool != nullptr && iIndex != LB_ERR) {
