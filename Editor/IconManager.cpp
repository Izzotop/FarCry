...
const char* ObjectNames[STATOBJECT_LAST] = {
    "Objects\\Editor\\Arrow.cgf",  "Objects\\Editor\\Axis.cgf",       "Objects\\Editor\\Sphere.cgf",
    "Objects\\Editor\\Anchor.cgf", "Objects\\Editor\\entrypoint.cgf", "Objects\\Editor\\hidepoint.cgf",
};
...
IStatObj* CIconManager::GetObject(EObject object) {
    ...
    if (!m_objects[object]) {
        ...
        m_objects[object]->SetShaderTemplate(EFT_USER_FIRST + 1, "s_ObjectColor", nullptr);
    }
    return m_objects[object];
}
