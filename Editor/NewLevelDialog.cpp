...
CNewLevelDialog::CNewLevelDialog(CWnd* pParent /*=nullptr*/)
    : CDialog(CNewLevelDialog::IDD, pParent), m_level(_T("")), m_useTerrain(FALSE), m_terrainResolution(0), m_terrainUnits(0) {
