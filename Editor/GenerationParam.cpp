...
CGenerationParam::CGenerationParam(CWnd* pParent /*=nullptr*/) : CDialog(CGenerationParam::IDD, pParent) {
...
void CGenerationParam::FillParam(SNoiseParams* pParam) {
    ...
    CLogFile::FormatLine("Retrieving parameters (fFade: %f, fFreq: %f, fFreqStep: %f) from dialog...", pParam->fFade, pParam->fFrequency, pParam->fFrequencyStep);
}
...
void CGenerationParam::LoadParam(SNoiseParams* pParam) {
    ...
    CLogFile::FormatLine("Loading parameters (fFade: %f, fFreq: %f, fFreqStep: %f) to dialog...", pParam->fFade, pParam->fFrequency, pParam->fFrequencyStep);
}
