...
static struct FileIconsMapping {
    ...
    {"cgf", 3}, {"cga", 4}, {"jpg", 5}, {"dds", 6}, {"tga", 7}, {"bmp", 8}, {"wav", 9}, {"ogg", 9}, {"mp3", 9},
};
...
CCustomFileDialog::CCustomFileDialog(OpenParams& fp, CWnd* pParent /*=nullptr*/) : CXTResizeDialog(CCustomFileDialog::IDD, pParent), m_fp(fp) {
    ...
    */
    ...
    if (m_bPreviewOn) {
        if (m_fp.filetype == EFILE_TYPE_GEOMETRY) {
            ...
            m_previewImageCtrl.SetBitmap(nullptr);
