...
CMainTools::CMainTools(CWnd* pParent /*=nullptr*/) : CDialog(CMainTools::IDD, pParent) {
...
void CMainTools::CreateButtons() {
    ...
    SetWindowPos(nullptr, 0, 0, rc.right - rc.left, newHeight + 4, SWP_NOMOVE);
}
...
void CMainTools::StartTimer() {
    StopTimer();
    m_nTimer = SetTimer(1, 500, nullptr);
}
