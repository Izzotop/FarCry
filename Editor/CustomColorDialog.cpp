...
CCustomColorDialog::CCustomColorDialog(COLORREF clrInit, DWORD dwFlags, CWnd* pParentWnd) : CColorDialog(clrInit, dwFlags, pParentWnd) {
...
void CCustomColorDialog::OnLButtonDown(UINT nFlags, CPoint point) {
    if (m_bPickMode) {
        ...
        CDC dc;
        CBitmap bmp;
        dcScreen.CreateDC("DISPLAY", nullptr, nullptr, nullptr);
