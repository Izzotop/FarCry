...
CObjectLayerPropsDialog::CObjectLayerPropsDialog(CWnd* pParent /*=nullptr*/)
    : CDialog(CObjectLayerPropsDialog::IDD, pParent), m_bVisible(TRUE), m_bFrozen(FALSE), m_bExternal(FALSE), m_bExportToGame(TRUE), m_name(_T("")) {
    m_bMainLayer = FALSE;
}
