...
public:
    ...
    void SetDescription(const CString& dsc) {
        m_description = dsc;
    }
    ...
    XmlNodeRef GetEnvironemnt() {
        return m_environment;
    };

    //! Return weapons ammo definitions for this mission.
    XmlNodeRef GetWeaponsAmmo() {
        return m_weaponsAmmo;
    };

    //! Return lighting used for this mission.
    LightingSettings* GetLighting() const {
        return m_lighting;
    };
    ...
    void SetPlayerEquipPack(const CString& sEquipPack) {
        m_sPlayerEquipPack = sEquipPack;
    }
    const CString& GetPlayerEquipPack() {
        return m_sPlayerEquipPack;
    }

    CMissionScript* GetScript() {
        return m_pScript;
    }

    void SetMusicScriptFilename(const CString& sMusicScript);
    const CString& GetMusicScriptFilename() {
        return m_sMusicScript;
    }
    ...
    int GetNumCGFObjects() const {
        return m_numCGFObjects;
    };
