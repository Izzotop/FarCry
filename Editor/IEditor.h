...
//////////////////////////////////////////////////////////////////////////
enum MouseCallbackFlags { MK_CALLBACK_FLAGS = 0x100 };
...
struct IEditor {
    ...
    virtual void UpdateViews(int flags = 0xFFFFFFFF, BBox* updateRegion = nullptr) = 0;
    ...
    // Only supposed to be called inside of IPlugin::CreateUIElements()
    virtual bool AddMenuItem(uint8 iId, bool bIsSeparator, eMenuInsertLocation eParent, IUIEvent* pIHandler) = 0;
    ...
    virtual int AddRollUpPage(int rollbarId, LPCTSTR pszCaption, CDialog* pwndTemplate = 0, bool bAutoDestroyTpl = true, int iIndex = -1) = 0;
    ...
    //! If parameter is nullptr current selection in material library does not change.
    virtual CBaseLibraryDialog* OpenDataBaseLibrary(EDataBaseLibraries dbLib, CBaseLibraryItem* pItem = nullptr) = 0;
