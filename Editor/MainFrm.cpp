...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
    ...
    //////////////////////////////////////////////////////////////////////////
    VERIFY(m_wndTerrainToolBar.CreateEx(this, TBSTYLE_TRANSPARENT | TBSTYLE_FLAT | TBSTYLE_LIST, dwToolBarFlags, nullptrRc, IDW_VIEW_TERRAIN_BAR));
    ...
    //////////////////////////////////////////////////////////////////////////
    VERIFY(m_wndAvoToolBar.CreateEx(this, TBSTYLE_TRANSPARENT | TBSTYLE_FLAT | TBSTYLE_LIST, dwToolBarFlags, nullptrRc, IDW_VIEW_AVI_RECORD_BAR));
    ...
    VERIFY(m_objectModifyBar.CreateEx(this, TBSTYLE_TRANSPARENT | TBSTYLE_FLAT, dwToolBarFlags, nullptrRc, IDW_VIEW_OBJECT_BAR));
    ...
    m_cConsole.Create(nullptr, nullptr, WS_CHILD | WS_VISIBLE, CRect(0, 0, 0, 0), &m_wndConsoleBar, m_wndConsoleBar.GetDlgCtrlID());
    ...
    m_wndDataBase.Create(CDataBaseDialog::IDD, &m_wndDataBaseBar);
    // m_wndDataBase.CreateEx( 0,"Dialog",nullptr,WS_POPUP|WS_VISIBLE,rc,&m_wndDataBaseBar,m_wndDataBaseBar.GetDlgCtrlID() );
    ...
    */
    ...
    /*
        ...
        //////////////////////////////////////////////////////////////////////////
        // Create Menu.
        VERIFY( m_wndMenuBar.Create( nullptr,this,ID_VIEW_MENUBAR ) );
        //////////////////////////////////////////////////////////////////////////
    ...
    //    m_ReBar.AddBar( &m_wndToolBar,RGB(0,0,0),RGB(255,255,255),"Main" );
        ...
        m_objectRollupCtrl.Create(WS_VISIBLE | WS_CHILD, CRect(4, 4, 187, 362), &m_wndRollUp, nullptr);
        m_wndRollUp.SetRollUpCtrl( ROLLUP_OBJECTS,&m_objectRollupCtrl);

        m_terrainRollupCtrl.Create(WS_VISIBLE | WS_CHILD, CRect(4, 4, 187, 362), &m_wndRollUp, nullptr);
        m_wndRollUp.SetRollUpCtrl( ROLLUP_TERRAIN,&m_terrainRollupCtrl );

        m_displayRollupCtrl.Create(WS_VISIBLE | WS_CHILD, CRect(4, 4, 187, 362), &m_wndRollUp, nullptr);
...
void CMainFrame::CreateRollupBar() {
    ...
    m_wndRollUp.Create(nullptr, nullptr, WS_CHILD | WS_VISIBLE, rc, &m_wndRollUpBar, m_wndRollUpBar.GetDlgCtrlID());
    ...
    m_layersRollupCtrl.Create(WS_VISIBLE | WS_CHILD, CRect(4, 4, 187, 362), &m_wndRollUp, nullptr);
...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs) {
    ...
    // cs.lpszClass = AfxRegisterWndClass( 0, nullptr, nullptr,AfxGetApp()->LoadIcon(IDR_MAINFRAME));
...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) {
    ...
    CRect rc;
    m_layoutWnd->CreateEx(0, nullptr, nullptr, WS_CHILD | WS_VISIBLE, rc, this, AFX_IDW_PANE_FIRST);
    if (IsPreview()) {
...
BOOL CMainFrame::OnCopyData(CWnd* pWnd, COPYDATASTRUCT* pCopyDataStruct) {
    ...
    if (pCopyDataStruct->dwData = 100 && pCopyDataStruct->lpData != nullptr) {
        char str[1024];
...
void CMainFrame::OnXPLook() {
    ...
    RecalcLayout();
    RedrawWindow( nullptr,nullptr,RDW_INVALIDATE|RDW_UPDATENOW|RDW_ERASE|RDW_FRAME|RDW_ALLCHILDREN );
    */
}
...
bool CMainFrame::FindMenuPos(CMenu* pBaseMenu, UINT myID, CMenu*& pMenu, int& mpos) {
    ...
    for (myPos = pBaseMenu->GetMenuItemCount() - 1; myPos >= 0; myPos--) {
        ...
        // This function will return nullptr if ther is NO SubMenu
        if (mNewMenu != nullptr) {
            // rekursive!
...
void CMainFrame::ShowDataBaseDialog(bool bShow) {
    ...
    // m_wndDataBase.RedrawWindow( nullptr,nullptr,RDW_INVALIDATE|RDW_UPDATENOW|RDW_ERASE|RDW_ALLCHILDREN );
}
