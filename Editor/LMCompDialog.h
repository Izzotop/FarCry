...
public:
    CLMCompDialog(CWnd* pParent = nullptr); // standard constructor
...
public:
    CButton m_cShadows;
    volatile SSharedLMEditorData
        m_sSharedData; // the shared data between lightmap compiler and editor during compilation, this should better be realized vbia a pattern, but next in version
#ifdef DEBUG_OUTPUTS
