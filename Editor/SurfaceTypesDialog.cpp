...
CSurfaceTypesDialog::CSurfaceTypesDialog(CWnd* pParent /*=nullptr*/) : CDialog(CSurfaceTypesDialog::IDD, pParent) {
...
void CSurfaceTypesDialog::OnImport() {
    ...
    CFileDialog dlg(TRUE, nullptr, "*.sft", OFN_FILEMUSTEXIST | OFN_NOCHANGEDIR, szFilters);
...
void CSurfaceTypesDialog::OnExport() {
    char szFilters[] = "Surface Types Files (*.sft)|*.sft||";
    CFileDialog dlg(FALSE, "sft", nullptr, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_NOCHANGEDIR, szFilters);
