...
CString CEditorImpl::GetRelativePath(const CString& fullPath) {
    ...
    PathRelativePathTo(path, GetMasterCDFolder(), FILE_ATTRIBUTE_DIRECTORY, srcpath, nullptr);
...
//////////////////////////////////////////////////////////////////////////
bool CEditorImpl::AddMenuItem(uint8 iId, bool bIsSeparator, eMenuInsertLocation eParent, IUIEvent* pIHandler) {
    //////////////////////////////////////////////////////////////////////
    ...
    PluginIt it;
    CMenu *pMainMenu = nullptr;
    CMenu *pLastPluginMenu = nullptr;
    DWORD dwMenuID;
    ...
    if (pIAssociatedPlugin == nullptr || pIHandler == nullptr)
            return false;
    ...
    {
            // Insert the menu
            if (!pLastPluginMenu->AppendMenu(MF_STRING | bIsSeparator ? MF_SEPARATOR : nullptr, dwMenuID,
...
//////////////////////////////////////////////////////////////////////////
int CEditorImpl::AddRollUpPage(int rollbarId, LPCTSTR pszCaption, class CDialog* pwndTemplate, bool bAutoDestroyTpl, int iIndex) {
...
bool CEditorImpl::ExecuteConsoleApp(const CString& CommandLine, CString& OutputText) {
    ...
    HANDLE hPipeOutputRead = nullptr;
    HANDLE hPipeOutputWrite = nullptr;
    HANDLE hPipeInputRead = nullptr;
    HANDLE hPipeInputWrite = nullptr;
    BOOL bTest = FALSE;
    bool bReturn = true;
    ...
    while (true) {
        // Read from the pipe
        bTest = ReadFile(hPipeOutputRead, &szOEMBuffer, 64, &dwNumberOfBytesRead, nullptr);
