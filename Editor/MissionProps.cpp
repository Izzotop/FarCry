...
CMissionProps::CMissionProps() : CPropertyPage(CMissionProps::IDD) {}
...
void CMissionProps::OnBnClickedCreate() {
    CString file;
    char szFilters[] = "Script Files (*.lua)|*.lua||";
    // CFileDialog Dlg(FALSE, "lua", CString(GetIEditor()->GetMasterCDFolder())+"scripts\\*.lua",
    // OFN_OVERWRITEPROMPT|OFN_PATHMUSTEXIST|OFN_NOCHANGEDIR|OFN_ENABLESIZING|OFN_EXPLORER, szFilters);
