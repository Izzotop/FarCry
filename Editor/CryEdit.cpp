...
BOOL CCryEditApp::FirstInstance() {
    CWnd* pwndFirst = CWnd::FindWindow(_T("CryEditorClass"), nullptr);
    if (pwndFirst) {
...
BOOL CCryEditApp::InitInstance() {
    ...
    // Check for 32bpp
    if (::GetDeviceCaps(GetDC(nullptr), BITSPIXEL) != 32)
    ...
    pDocTemplate = new CSingleDocTemplate(IDR_MAINFRAME, RUNTIME_CLASS(CCryEditDoc),
...
BOOL CCryEditApp::OnIdle(LONG lCount) {
    ...
    */
    ...
    int res = 0;
    /*
    if (pWndForeground != nullptr && (pWndForeground == m_pMainWnd || m_pMainWnd->IsChild(pWndForeground)
...
void CCryEditApp::ExportToGame() {
    ...
    // Ask first
    nResult = MessageBox(AfxGetMainWnd()->GetSafeHwnd(),
                         "You are about to perform a game data export that"
                         " includes exporting the surface texture. This can take several minutes, do you want to"
                         " continue ?",
                         "Exporting", MB_ICONINFORMATION | MB_YESNO | MB_APPLMODAL | MB_TOPMOST);
...
void CCryEditApp::OnSelectionSave() {
    ...
    CFileDialog dlg(FALSE, "grp", nullptr, OFN_OVERWRITEPROMPT | OFN_NOCHANGEDIR, szFilters);
    CFile cFile;
...
void CCryEditApp::OnOpenLevel() {
    ...
    */
    ...
    // OnFileOpen();
    {
        ...
        CFileDialog dlgFile(TRUE, nullptr, nullptr, OFN_ENABLESIZING | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_PATHMUSTEXIST | OFN_NOCHANGEDIR, szFilters);
...
void CCryEditApp::TagLocation(int index) {
    ...
    if (f) {
        for (int i = 0; i < 12; i++) {
            fprintf(f, "%f,%f,%f,%f,%f,%f\n", m_tagLocations[i].x, m_tagLocations[i].y, m_tagLocations[i].z, m_tagAngles[i].x, m_tagAngles[i].y, m_tagAngles[i].z);
        }
        fclose(f);
    }
}
...
//////////////////////////////////////////////////////////////////////////
void CCryEditApp::OnTagLocation1() {
    TagLocation(1);
}
void CCryEditApp::OnTagLocation2() {
    TagLocation(2);
}
void CCryEditApp::OnTagLocation3() {
    TagLocation(3);
}
void CCryEditApp::OnTagLocation4() {
    TagLocation(4);
}
void CCryEditApp::OnTagLocation5() {
    TagLocation(5);
}
void CCryEditApp::OnTagLocation6() {
    TagLocation(6);
}
void CCryEditApp::OnTagLocation7() {
    TagLocation(7);
}
void CCryEditApp::OnTagLocation8() {
    TagLocation(8);
}
void CCryEditApp::OnTagLocation9() {
    TagLocation(9);
}
void CCryEditApp::OnTagLocation10() {
    TagLocation(10);
}
void CCryEditApp::OnTagLocation11() {
    TagLocation(11);
}
void CCryEditApp::OnTagLocation12() {
    TagLocation(12);
}

//////////////////////////////////////////////////////////////////////////
void CCryEditApp::OnGotoLocation1() {
    GotoTagLocation(1);
}
void CCryEditApp::OnGotoLocation2() {
    GotoTagLocation(2);
}
void CCryEditApp::OnGotoLocation3() {
    GotoTagLocation(3);
}
void CCryEditApp::OnGotoLocation4() {
    GotoTagLocation(4);
}
void CCryEditApp::OnGotoLocation5() {
    GotoTagLocation(5);
}
void CCryEditApp::OnGotoLocation6() {
    GotoTagLocation(6);
}
void CCryEditApp::OnGotoLocation7() {
    GotoTagLocation(7);
}
void CCryEditApp::OnGotoLocation8() {
    GotoTagLocation(8);
}
void CCryEditApp::OnGotoLocation9() {
    GotoTagLocation(9);
}
void CCryEditApp::OnGotoLocation10() {
    GotoTagLocation(10);
}
void CCryEditApp::OnGotoLocation11() {
    GotoTagLocation(11);
}
void CCryEditApp::OnGotoLocation12() {
    GotoTagLocation(12);
}
