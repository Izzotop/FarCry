...
bool CEAXPresetMgr::Load(CString sFilename) {
    ...
    if (!pScriptSystem)
        return false;
    pScriptSystem->SetGlobalTonullptr("EAXPresetDB");
...
public:
    CEAXPresetUpdateSODump(IScriptSystem* pScriptSystem, _SmartScriptObject& pObj, CString& sPresetName, CString& sPropName, CString& sPropValue, bool bCorrectPreset = false)
